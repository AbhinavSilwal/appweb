        ...
        if (e.fn.fancybox) console.info("fancyBox already initialized");
            ...
            e.extend(y.prototype, {
                ...
                modifyContent: function(a, b) {
                    ...
                    e.each(a, function(d, k) {
                        ...
                        "auto" == d.opts.smallBtn && (d.opts.smallBtn = -1 < e.inArray(d.type, ["html",
                            "inline", "ajax"
                        ]));
                        ...
                        "function" === e.type(d.opts.caption) && (d.opts.caption = d.opts.caption.apply(k, [c,
                            d
                        ]));
                ...
                addEvents: function() {
                    ...
                    m.on("orientationchange.fb resize.fb", function(b) {
                        b && b.originalEvent && "resize" === b.originalEvent.type ? (a.requestId && f(a.requestId), a.requestId = A(function() {
                            a.update(b)
                        })) : (a.current && "iframe" === a.current.type &&
                    ...
                    n.on("keydown.fb", function(b) {
                        var c = (e.fancybox ? e.fancybox.getInstance() : null).current,
                            d = b.keyCode || b.which;
                        9 == d ? c.opts.trapFocus && a.focus(b) : !c.opts.keyboard || b.ctrlKey || b.altKey || b.shiftKey || e(b.target).is("input,textarea,video,audio,select,*[contenteditable]") || (8 === d || 27 === d ? (b.preventDefault(), a.close(b)) : 37 === d || 38 === d ? (b.preventDefault(), a.previous()) : 39 === d || 40 === d ? (b.preventDefault(),
                            a.next()) : a.trigger("afterKeydown", b, d))
                    });
                ...
                jumpTo: function(a, b) {
                    ...
                    if (!(c.isDragging || c.isClosing || c.isAnimating && c.firstRun)) {
                        a = parseInt(a, 10);
                        var k = c.current ? c.current.opts.loop :
                            c.opts.loop;
                ...
                updateSlide: function(a, b) {
                    ...
                    c && (d || k || "video" === a.contentType) && !a.hasError && (e.fancybox.stop(c), e.fancybox.setTranslate(c, this.getFitPos(a)),
                ...
                updateCursor: function(a, b) {
                    ...
                    c && !this.isClosing && this.Guestures && (d.removeClass("fancybox-is-zoomable fancybox-can-zoomIn fancybox-can-zoomOut fancybox-can-swipe fancybox-can-pan"),
                ...
                isZoomable: function() {
                    var a = this.current,
                        b;
                    return a && !this.isClosing && "image" === a.type &&
                        !a.hasError && (!a.isLoaded || (b = this.getFitPos(a)) && (a.width > b.width || a.height > b.height)) ? !0 : !1
                },
                ...
                canPan: function(a, b) {
                    ...
                    "image" === c.type && (c.isComplete || a && b) && !c.hasError && (k = this.getFitPos(c), a !== l && b !== l ? d = {
                        width: a,
                        height: b
                    } : c.isComplete && (d = e.fancybox.getTranslate(c.$content)), d && k && (k = 1.5 <
                        Math.abs(d.width - k.width) || 1.5 < Math.abs(d.height - k.height)));
                    return k
                },
                    ...
                    if (!a.isLoading && !a.isLoaded) {
                        ...
                        switch (c) {
                            ...
                            case "html":
                                ...
                                break;
                            case "video":
                                b.setContent(a, a.opts.video.tpl.replace(/\{\{src\}\}/gi, a.src).replace("{{format}}",
                                    a.opts.videoFormat || a.opts.video.format || "").replace("{{poster}}", a.thumb || ""));
                                break;
                            case "inline":
                ...
                setImage: function(a) {
                    ...
                    if (!1 !== a.opts.preload && a.opts.width && a.opts.height && a.thumb) {
                        ...
                        a.$ghost = e(c).addClass("fancybox-image").appendTo(a.$content).attr("src",
                            a.thumb)
                    }
                    b.setBigImage(a)
                },
                ...
                setBigImage: function(a) {
                    ...
                    a.$image = d.one("error", function() {
                        ...
                        b.isClosing || (a.opts.srcset && ((k = a.opts.sizes) && "auto" !== k || (k = (1 < a.width / a.height && 1 < m.width() / m.height() ?
                            "100" : Math.round(a.width / a.height * 100)) + "vw"), d.attr("sizes", k).attr("srcset", a.opts.srcset)), a.$ghost && setTimeout(function() {
                    ...
                    c.preload ? (b.showLoading(a), k.on("load.fb error.fb", function(q) {
                        ...
                        if (1 === k[0].isReady) {
                            ...
                            C && C.length && C.children().length && (d.css("overflow", "visible"), q.css({
                                ...
                                "max-width": "100%",
                                height: "9999px"
                            }), w === l && (w = Math.ceil(Math.max(C[0].clientWidth, C.outerWidth(!0)))), q.css("width", w ? w : "").css("max-width", ""), t === l && (t = Math.ceil(Math.max(C[0].clientHeight, C.outerHeight(!0)))), q.css("height",
                                t ? t : ""), d.css("overflow", "auto"));
                ...
                setContent: function(a, b) {
                    this.isClosing || (this.hideLoading(a), a.$content && e.fancybox.stop(a.$content), a.$slide.empty(), b && b.hasOwnProperty && b instanceof e && b.parent().length ? ((b.hasClass("fancybox-content") || b.parent().hasClass("fancybox-content")) &&
                            b.parents(".fancybox-slide").trigger("onReset"), a.$placeholder = e("<div>").hide().insertAfter(b), b.css("display", "inline-block")) : a.hasError || ("string" === e.type(b) && (b = e("<div>").append(e.trim(b)).contents()), a.opts.filter && (b = e("<div>").html(b).find(a.opts.filter))), a.$slide.one("onReset", function() {
                            ...
                            a.$smallBtn && (a.$smallBtn.remove(), a.$smallBtn =
                                null);
                        ...
                        a.$content.addClass("fancybox-content"), a.$slide.addClass("fancybox-slide--" + a.contentType), this.afterLoad(a))
                },
                setError: function(a) {
                    a.hasError = !0;
                ...
                afterLoad: function(a) {
                    this.isClosing || (a.isLoading = !1, a.isLoaded = !0, this.trigger("afterLoad", a), this.hideLoading(a), !a.opts.smallBtn || a.$smallBtn && a.$smallBtn.length || (a.$smallBtn = e(this.translate(a, a.opts.btnTpl.smallBtn)).appendTo(a.$content)), a.opts.protect && a.$content && !a.hasError && (a.$content.on("contextmenu.fb", function(b) {
                        ...
                        this.adjustCaption(a), this.adjustLayout(a), a.pos === this.currPos && this.updateCursor(), this.revealContent(a))
                },
                adjustCaption: function(a) {
                    ...
                    c && b && b.length && (a.pos !== this.currPos ? (c = d.clone().appendTo(d.parent()), c.children().eq(0).empty().html(b), k = c.outerHeight(!0), c.empty().remove()) : this.$caption && (k = this.$caption.outerHeight(!0)), a.$slide.css("padding-bottom",
                        k || ""))
                },
                ...
                revealContent: function(a) {
                    ...
                    if ("zoom" === t) b.isAnimating = !0, d.scaleX = d.width / k.width, d.scaleY = d.height / k.height, q = a.opts.zoomOpacity,
                        "auto" == q && (q = .1 < Math.abs(a.width / a.height - k.width / k.height)), q && (k.opacity = .1, d.opacity = 1), e.fancybox.setTranslate(a.$content.removeClass("fancybox-is-hidden"), k), u(a.$content), e.fancybox.animate(a.$content, d, B, function() {
                            b.isAnimating = !1;
                            b.complete()
                        });
                ...
                complete: function() {
                    ...
                    if (!a.isMoved() && b.isLoaded) {
                        ...
                        a.updateCursor();
                        a.trigger("afterShow");
                        if (b.opts.video.autoStart) b.$slide.find("video,audio").filter(":visible:first").trigger("play").one("ended",
                            function() {
            ...
            e.fancybox = {
                ...
                getInstance: function(a) {
                    ...
                    return b instanceof y ? ("string" === e.type(a) ? b[a].apply(b, c) : "function" === e.type(a) && a.apply(b, c),
                        b) : !1
                },
                open: function(a, b, c) {
                    return new y(a, b, c)
                ...
                stop: function(a, b) {
                    a && a.length && (clearTimeout(a.data("timer")), b && a.trigger(h), a.off(h).css("transition-duration",
...
(function(p) {
    ...
    p(document).on("objectNeedsType.fb",
        function(g, r, m) {
            var n = m.src || "",
                z = !1,
                A, f, h, u, v, y;
            ...
            p.each(g, function(a, b) {
                if (f = n.match(b.matcher)) {
                    ...
                    A = "function" === p.type(b.thumb) ? b.thumb.call(this,
                        f, h, m) : e(b.thumb, f);
    ...
    p(document).on({
        "afterShow.fb": function(g, r, m) {
            1 < r.group.length && ("youtube" === m.contentSource ||
                "vimeo" === m.contentSource) && l.load(m.contentSource)
        }
    })
})(jQuery);
(function(p, x, e) {
    var l = function() {
        ...
        n = function(f) {
            ...
            for (var u = f.length; h < u; h++)
                if ("data-fancybox-" === f[h].nodeName.substr(0,
                        14)) return !0;
            return !1
        },
        z = function(f) {
    ...
    A.prototype.ontouchstart = function(f) {
        ...
        if (!(f.originalEvent && 2 == f.originalEvent.button || !y.length || !h.length || n(h) || n(h.parent()) || !h.is("img") &&
                f.originalEvent.clientX > h[0].clientWidth + h.offset().left))
            ...
            this.distanceX = this.distanceY = this.distance =
                0;
            ...
            e(x).off(".fb.touch").on(b ?
                "touchend.fb.touch touchcancel.fb.touch" : "mouseup.fb.touch mouseleave.fb.touch", e.proxy(this, "ontouchend")).on(b ? "touchmove.fb.touch" : "mousemove.fb.touch", e.proxy(this, "ontouchmove"));
            ...
            e.fancybox.isMobile &&
                this.isScrollable || f.preventDefault();
    ...
    A.prototype.ontouchmove = function(f) {
        if (void 0 !== f.originalEvent.buttons &&
            0 === f.originalEvent.buttons) this.ontouchend(f);
    ...
    A.prototype.onSwipe = function(f) {
        ...
        !0 === f ? 10 < Math.abs(h.distance) && (h.canTap = !1, 2 > u.group.length && h.opts.vertical ? h.isSwiping = "y" : u.isDragging || !1 === h.opts.vertical || "auto" === h.opts.vertical && 800 < e(p).width() ? h.isSwiping = "x" : (f = Math.abs(180 * Math.atan2(h.distanceY, h.distanceX) / Math.PI), h.isSwiping = 45 < f && 135 > f ? "y" : "x"), "y" === h.isSwiping && e.fancybox.isMobile && h.isScrollable ? h.isScrolling = !0 : (u.isDragging =
            h.isSwiping, h.startPoints = h.newPoints, e.each(u.slides, function(y, a) {
            ...
            left: v
        }, h.requestId && (g(h.requestId), h.requestId =
            null), h.requestId = l(function() {
    ...
    A.prototype.onPan = function() {
        ...
        m(f.newPoints[0], f.realPoints[0]) < (e.fancybox.isMobile ? 10 : 5) ? f.startPoints = f.newPoints : (f.canTap = !1, f.contentLastPos = f.limitMovement(), f.requestId && g(f.requestId), f.requestId = l(function() {
            e.fancybox.setTranslate(f.$content,
                f.contentLastPos)
        }))
    };
    ...
    A.prototype.ontouchend = function(f) {
        ...
        u ? this.endPanning() : v ? this.endZooming() :
            this.endSwiping(h, y)
    };
    A.prototype.endSwiping = function(f, h) {
        ...
        !1 !== u || "x" !=
            f && "y" != f || this.instance.centerSlide(200);
    ...
    A.prototype.endZooming = function() {
        ...
        if (this.contentLastPos) {
            ...
            h < this.canvasWidth && u < this.canvasHeight ? this.instance.scaleToFit(150) : h > f.width || u > f.height ? this.instance.scaleToActual(this.centerPointStartX, this.centerPointStartY, 150) : (f = this.limitPosition(v,
                y, h, u), e.fancybox.animate(this.$content, f, 150))
        }
    };
...
(function(p, x) {
    ...
    x.extend(e.prototype, {
        ...
        set: function(l) {
            var g = this.instance,
                r = g.current;
            r && (!0 === l || r.opts.loop || g.currIndex < g.group.length - 1) ? this.isActive && "video" !== r.contentType &&
                (this.$progress && x.fancybox.animate(this.$progress.show(), {
                    scaleX: 1
        ...
        start: function() {
            ...
            l && (this.$button.attr("title", (l.opts.i18n[l.opts.lang] ||
                l.opts.i18n.en).PLAY_STOP).removeClass("fancybox-button--play").addClass("fancybox-button--pause"), this.isActive = !0, l.isComplete && this.set(!0), this.instance.trigger("onSlideShowChange", !0))
        },
        stop: function() {
            var l = this.instance.current;
            this.clear();
    ...
    x(p).on({
        ...
        "beforeClose.fb onDeactivate.fb": function(l,
            g) {
...
(function(p, x) {
    ...
    x(p).on({
        "onInit.fb": function(g, r) {
            e ?
                r && r.group[r.currIndex].opts.fullScreen ? (g = r.$refs.container, g.on("click.fb-fullscreen", "[data-fancybox-fullscreen]", function(m) {
                    m.stopPropagation();
                    m.preventDefault();
                    l.toggle()
    ...
    e(function() {
        !1 !== e.fancybox.defaults.hash && (e(x).on({
            ...
            "beforeShow.fb": function(m, n, z, A) {
                z && !1 !== z.opts.hash && (m = r(n)) && (n.currentHash = m + (1 < n.group.length ?
                    "-" + (z.index + 1) : ""), p.location.hash !== "#" + n.currentHash && (A && !n.origHash && (n.origHash = p.location.hash), n.hashTimer && clearTimeout(n.hashTimer), n.hashTimer = setTimeout(function() {
            ...
            "beforeClose.fb": function(m, n, z) {
                z && !1 !== z.opts.hash && (clearTimeout(n.hashTimer), n.currentHash && n.hasCreatedHistory ?
                    p.history.back() : n.currentHash && ("replaceState" in p.history ? p.history.replaceState({}, x.title, p.location.pathname + p.location.search + (n.origHash || "")) : p.location.hash = n.origHash), n.currentHash = null)
            }
            ...
            n ? n.currentHash === m.gallery + "-" + m.index || 1 === m.index && n.currentHash == m.gallery || (n.currentHash = null, n.close()) : "" !== m.gallery &&
                g(m)
        }), setTimeout(function() {
    ...
    XF.Lightbox = XF.Element.newHandler({
        ...
        init: function() {
            ...
            e(k).on("click", "a.js-lightboxCloser", function(a) {
                a = e(a.target);
                XF.findRelativeIf("< .fancybox-inner | .fancybox-toolbar",
                    a).find("[data-fancybox-close]").click()
            })
        },
        ...
        _initContainer: function(a) {
            if (!a.data("lbInitialized")) {
                ...
                a.on("lightbox:after-close", XF.proxy(this,
                    "afterClose"))
            }
        },
        ...
        afterLoad: function(a, b, c, d) {
            "ajax" === d.type && (a = d.$content, b = a.find(".js-embedContent"),
                c = {}, b.length && (c[b.data("media-site-id")] = !0, XF.applyJsState(XF.config.jsState, c), d.$slide.removeClass("fancybox-slide--video").addClass("fancybox-slide--embed")), XF.activate(a))
        },
        ...
        sidebarLoaded: function(a) {
            if (a.html && this.$sidebar) {
                ...
                XF.setupHtmlInsert(a.html, function(c, d, g) {
                    b.$sidebar && (b.$sidebar.find(".fancybox-sidebar-content").html(c),
                        b.$sidebar.removeClass("is-loading"))
                })
            }
        },
        ...
        beforeClose: function(a, b, c, d) {
            ...
            this.$sidebar && (this.$sidebar.remove(),
                this.$sidebar = null, e(l).off("resize.lbSidebar"))
        },
        afterClose: function() {
            XF.Modal.close();
        ...
        updateCaption: function(a) {
            if (!a.data("caption")) {
                var b = a.closest(this.options.lbContainer),
                    ...
                    d = b.data("lb-id");
                b = {
                    title: b.data("lb-caption-title") ||
                        c.attr("alt") || c.attr("title") || "",
