    ...
    XF.activate ? console.error("XF core has been double loaded") : (XF.browser || (XF.browser = {
            ...
            var a = function() {
                var f = r.createElement("fake"),
                    ...
                    d;
                for (d in e)
                    if (void 0 !== f.style[d]) return {
                        end: e[d]
                    };
                return !1
            }();
            g.support.transition = a;
            g.support.transition && (g.event.special.xfTransitionEnd = {
                bindType: a.end,
                delegateType: a.end,
                handle: function(f) {
                    if (g(f.target).is(this)) return f.handleObj.handler.apply(this, arguments)
                }
            });
            var b = g("html").attr("dir");
            a = "normal";
            if (b && "RTL" == b.toUpperCase()) {
                b = g('<div style="width: 80px; height: 40px; font-size: 30px; overflow: scroll; white-space: nowrap; word-wrap: normal; position: absolute; top: -1000px; visibility: hidden; pointer-events: none">MMMMMMMMMM</div>');
                var c = b[0];
                b.appendTo("body");
            ...
            g.addEventCapture = function() {
                ...
                return function(e) {
                    r.addEventListener && ("string" == typeof e && (e = [e]), g.each(e, function(d, h) {
                        var k = function(m) {
                            m = g.event.fix(m);
                            return g.event.dispatch.call(this, m)
                        };
                        f[h] = f[h] || {};
                        f[h].setup || f[h].teardown || g.extend(f[h], {
                            setup: function() {
            ...
            xfFadeDown: function(a, b) {
                ...
                this.animate({
                    ...
                    easing: "swing",
                    complete: function() {
                        g(this).find(".was-sticky").addClass("is-sticky").removeClass("was-sticky");
                        b && b();
                        XF.layoutChange()
                    }
                });
                    ...
                    switch (b.css("position")) {
                        ...
                        case "-webkit-sticky":
                            var c = b.dimensions(!0),
                                ...
                                e = b.css("top"),
                                d = b.css("bottom");
                            if ("auto" !== e && (e = c.top - f.top - parseInt(e, 10), .5 >= e && -.5 <= e) || "auto" !== d &&
                                (e = c.bottom - f.bottom - parseInt(d, 10), .5 >= e && -.5 <= e)) return a = b, !1
                    }
                });
                return a
            },
            ...
            focusNext: function() {
                var a = g('input:not([type="hidden"]), select, textarea, a, button').filter(":visible");
                return a.eq(a.index(this) + 1).focus()
            },
            retinaFix: function() {
                if (2 <= q.devicePixelRatio) this.find("img[srcset]").one("load", function(a) {
            ...
            function a(e) {
                ...
                d = 0;
                e && e.match(/^(\+|-|)([0-9]*\.[0-9]+|[0-9]+)(ms|s)/i) && (d = ("-" == RegExp.$1 ? -1 : 1) * parseFloat(RegExp.$2) * ("ms" == RegExp.$3.toLowerCase() ? 1 : 1E3));
                return d
            }

            function b(e, d, h) {
                var k = [];
                g.isFunction(d) && (d = d.call(e[0],
                    0, e[0].className));
                d = g.trim(d).split(/\s+/);
                e = " " + e[0].className + " ";
                for (var m, l = 0; l < d.length; l++)((m = 0 <= e.indexOf(" " + d[l] + " ")) && !h || !m && h) && k.push(d[l]);
                return k.join(" ")
            }
            ...
            function c(e, d, h, k, m) {
                ...
                if (d.length)
                    if (0 >= m) e[l](d), t();
                        ...
                        if (e.css("transition-property").match(/(^|\s|,)-xf-(width|height)($|\s|,)/)) {
                            t = RegExp.$2;
                            var x = f[t],
                                v = e.css(x),
                                y = v[t],
                                ...
                                u = e.data(w),
                                z = n.style,
                                B = z.transition || z["-webkit-transition"] || z["-moz-transition"] || z["-o-transition"] || "",
                                A;
                            if (void 0 === u)
                                for (u = {}, A = 0; A < x.length; A++) u[x[A]] = z[x[A]] || "";
                            if (0 == e[t]())
            ...
            g.fn.addClassTransitioned = function(e, d, h) {
                for (var k = this.length, m = 0; m < k; m++) c(g(this[m]), !0, e, d, h);
                return this
            };
            g.fn.removeClassTransitioned = function(e, d, h) {
                for (var k = this.length, m = 0; m < k; m++) c(g(this[m]), !1, e, d, h);
                return this
            };
            g.fn.toggleClassTransitioned = function(e, d, h, k) {
                "boolean" !== typeof d && "undefined" === typeof h && (h = d, d = null);
                for (var m = "boolean" === typeof d, l = this.length, p = 0; p < l; p++) {
                    var n = g(this[p]);
            ...
            onPageLoad: function() {
                ...
                g(r).on("ajax:before-success", function(a, b, c, f) {
                    (b = f.responseJSON) && b && b.job && (a = b.job, a.manual && XF.JobRunner.runManual(a.manual), a.autoBlocking ? XF.JobRunner.runAutoBlocking(a.autoBlocking, a.autoBlockingMessage) : a.auto && setTimeout(XF.JobRunner.runAuto, 0))
                });
                g(r).on("keyup", "a:not([href])", function(a) {
                    "Enter" == a.key && g(a.currentTarget).click()
                });
                g("html[data-run-jobs]").length && setTimeout(XF.JobRunner.runAuto, 100);
            ...
            addExtraPhrases: function(a) {
                g(a).find("script.js-extraPhrases").each(function() {
                    var b = g(this);
                    try {
            ...
            isElementVisible: function(a) {
                ...
                return 0 <= a.top && 0 <= a.left && a.bottom <= g(q).height() &&
                    a.right <= g(q).width()
            },
            ...
            updateAvatars: function(a, b, c) {
                g(".avatar").each(function() {
                    var f = g(this),
                        ...
                        d = "avatar-u" + a + "-",
                        h = f.hasClass("avatar--updateLink") ? f.find(".avatar-update") : null;
                    if ((c || !e.hasClass(".js-croppedAvatar")) && e.is('[class^="' + d + '"]')) {
                        if (e.hasClass(d +
                                "s")) e = g(b.s);
            ...
            updateVisitorCounts: function(a, b, c) {
                a && "public" == XF.getApp() && (XF.badgeCounterUpdate(g(".js-badge--conversations"), a.conversations_unread), XF.badgeCounterUpdate(g(".js-badge--alerts"), a.alerts_unviewed), XF.config.visitorCounts.title_count && XF.pageTitleCounterUpdate(a.total_unread), XF.config.visitorCounts.icon_indicator && XF.faviconUpdate(a.total_unread), b && (XF.appBadgeUpdate(a.total_unread), XF.CrossTab.trigger("visitorCounts", a), XF.LocalStorage.setJson("visitorCounts", {
                ...
                if (b !== XF.favIconAlertShown) {
                    ...
                    if (c.length) {
                        ...
                        c.each(function(e, d) {
                            ...
                            f.shouldCountBeShown(a) ? (d || h.data("original-href", e), g("<img />").on("load", function() {
                                var k = XF.faviconDraw(this);
                                k && h.attr("href", k)
                            }).attr("src", e)) : d && h.attr("href", d).removeData("original-href")
                        })
                    }
                }
            },
            ...
            unparseBbCode: function(a) {
                ...
                g.each(["B", "I", "U", "S"], function(c, f) {
                    b.find(f).each(function() {
                        g(this).replaceWith("[" + f + "]" + g(this).html() + "[/" + f + "]")
                    })
                });
                b.find(".bbCodeBlock--quote").each(function() {
                    var c = g(this),
                        f = c.find(".bbCodeBlock-expandContent");
                    f.length ? c.replaceWith("<div>[QUOTE]" + f.html() + "[/QUOTE]</div>") : f.find(".bbCodeBlock-expand").remove()
                });
                ...
                b.find('div[style*="text-align"]').each(function() {
                    ...
                    g(this).replaceWith("[" + c + "]" + g(this).html() + "[/" + c + "]")
                });
            ...
            hideTooltips: function() {
                g.each(XF.TooltipTrigger.cache,
                    function(a, b) {
                        b.hide()
                    })
            },
            ...
            loadScripts: function(a, b) {
                ...
                function f() {
                    for (var n; m[0] && "loaded" == m[0].readyState;) n = m.shift(), n.onreadystatechange = null, n.onerror = null, h.appendChild(n), c()
                }
                var e = r.scripts[0],
                    d = "async" in e;
                e = e.readyState;
                ...
                for (l in a)
                    if (a.hasOwnProperty(l)) {
                        var p = a[l];
                        XF.loadedScripts[p] || (XF.loadedScripts[p] = !0, k++, d ? function(n) {
                                var t = g("<script>").prop({
                                    src: n,
                                    async: !1
                                });
            ...
            ajax: function(a, b, c, f, e) {
                ...
                var d = !0,
                    h = !0,
                    k = !0;
                e && (e.skipDefault && (h = d = !1, delete e.skipDefault), e.skipDefaultSuccessError && (h = !1, delete e.skipDefaultSuccessError), e.skipDefaultSuccess && (d = !1, delete e.skipDefaultSuccess),
                    e.skipError && (k = !1, delete e.skipError));
                var m = function(n, t, x) {
                        g(r).trigger("ajax:before-success", [n, t, x]);
                        h && XF.defaultAjaxSuccessError(n, t, x) || d && XF.defaultAjaxSuccess(n, t, x) || f && f(n, t, x)
                    },
                    l = function(n, t, x) {
                        if (n.readyState) try {
                ...
                c = XF.dataPush(c, "_xfRequestUri", q.location.pathname + q.location.search);
                c = XF.dataPush(c, "_xfWithData", 1);
                XF.config.csrf && (c = XF.dataPush(c, "_xfToken", XF.config.csrf));
                var p = q.FormData && c instanceof
                FormData;
                a = g.extend(!0, {
                    cache: !0,
                    data: c || {},
            ...
            dataPush: function(a, b, c) {
                a && "string" != typeof a ? void 0 !== a[0] ?
                    a.push({
                        name: b,
                        value: c
                    }) : q.FormData && a instanceof FormData ? a.append(b, c) : a[b] = c : (a = String(a), a += "&" + encodeURIComponent(b) + "=" + encodeURIComponent(c));
                return a
            },
            defaultAjaxSuccessError: function(a, b, c) {
                ...
                return a.errorHtml ? (XF.setupHtmlInsert(a.errorHtml,
                    function(f, e) {
                        e = e.h1 || e.title || XF.phrase("oops_we_ran_into_some_problems");
                    ...
                    if (c) {
                        ...
                        if (f) {
                            ...
                            g.each(f, function(p, n) {
                                "number" === typeof p ? l.push(XF.regexQuote(g.trim(n))) : l.push(XF.regexQuote(g.trim(p)))
                            });
                            l.length && (h = new RegExp("^(" + l.join("|") + ")(\\[|$)"))
                        }
                        a.each(function(p, n) {
                            (p = n.name) && "_xf" !== p.substring(0, 3) ? !h || h.test(p) ? k.push(n) : m.push(n) : m.push(n)
                        });
            ...
            setupHtmlInsert: function(a, b, c) {
                if ("string" === typeof a || a instanceof g) a = {
                    content: a
                };
                if ("object" == typeof a && a.content) {
                    ...
                    XF.Loader.load(a.js, a.css, function() {
                        var e, d = a.jsInline || [],
                            ...
                            m = f[2] ? !0 : !1;
                        if (a.cssInline)
                            for (e = 0; e < a.cssInline.length; e++) g("<style>" + a.cssInline[e] + "</style>").appendTo("head");
                        if (k) {
                            var l;
                            h = g.trim(h);
                            if (!m)
                                for (; e = XF.scriptMatchRegex.exec(h);) {
                                    var p = !1;
                                    if (l = e[1].match(/(^|\s)type=("|'|)([^"' ;]+)/)) switch (l[3].toLowerCase()) {
                            ...
                            h = h.replace(/<noscript>([\s\S]*?)<\/noscript>/ig, "")
                        }
            ...
            alert: function(a, b, c, f) {
                var e = a;
                "object" == typeof a && (e = "<ul>", g.each(a, function(d, h) {
                    e += "<li>" + h + "</li>"
            ...
            getOverlayHtml: function(a) {
                ...
                g.isPlainObject(a) && (b = g.extend({}, b, a), a.html && (a =
                    a.html));
                if ("string" == typeof a) a = g(g.parseHTML(a));
                else if (!(a instanceof g)) throw Error("Can only create an overlay with html provided as a string or jQuery object");
                if (!a.is(".overlay")) {
                    var c = b.title;
                    if (!c) {
                    ...
                    f.length && (a = f);
                    f = g('<div class="overlay" tabindex="-1" data-url="' + b.url + '"><div class="overlay-title"></div><div class="overlay-content"></div></div>');
            ...
            getMultiBarHtml: function(a) {
                ...
                if ("string" == typeof a) a = g(g.parseHTML(a));
                else if (!(a instanceof g)) throw Error("Can only create an action bar with html provided as a string or jQuery object");
                b = g('<div class="multiBar" tabindex="-1"><div class="multiBar-inner"><span>Hello there.</span></div></div>');
            ...
            overlayMessage: function(a, b) {
                ...
                else if (!(b instanceof g)) throw Error("Can only create an overlay with html provided as a string or jQuery object");
                b.is(".block, .blockMessage") || b.find(".block, .blockMessage").length || (b = g('<div class="blockMessage" />').html(b));
                b = XF.getOverlayHtml({
                    title: a,
                    html: b
                });
            ...
            flashMessage: function(a, b, c) {
                var f = g('<div class="flashMessage"><div class="flashMessage-content"></div></div>');
            ...
            redirect: function(a) {
                XF.isRedirecting = !0;
                if (XF.JobRunner.isBlockingJobRunning()) return g(r).one("job:blocking-complete", function() {
                    XF.redirect(a)
                }), !1;
            ...
            insertIntoEditor: function(a, b, c, f) {
                return XF.modifyEditorContent(a, function(e) {
                    e.insertContent(b)
                }, function(e) {
            ...
            modifyEditorContent: function(a, b, c, f) {
                ...
                return a ? XF.Editor && a instanceof XF.Editor ? (a.isBbCodeView() ? (b = a.ed.bbCode.getTextArea(), c(b), b.trigger("autosize")) : b(a), !0) : a instanceof g && a.is("textarea") ? (c(a), a.trigger("autosize"), !0) : !1 : !1
            },
            ...
            focusEditor: function(a, b) {
                ...
                return a ? XF.Editor && a instanceof XF.Editor ? (a.isInitialized() && a.scrollToCursor(), !0) : a instanceof g && a.is("textarea") ? (a.autofocus(), !0) : !1 : !1
            },
            ...
            bottomFix: function(a) {
                ...
                b ? b.append(a) : g(a).css({
                    position: "fixed",
                    bottom: 0
                }).appendTo("body")
            },
            addFixedMessage: function(a, b) {
                var c = g(g.parseHTML('<div class="fixedMessageBar"><div class="fixedMessageBar-inner"><div class="fixedMessageBar-message"></div><a class="fixedMessageBar-close" data-close="true" role="button" tabindex="0" aria-label="' + XF.phrase("close") + '"></a></div></div>'));
            ...
            windowHeight: function() {
                return XF.browser.ios || XF.browser.android ? q.innerHeight : g(q).height()
            },
            pageLoadScrollFix: function() {
                if (!XF.Feature.has("overflowanchor") && q.location.hash) {
                    ...
                    "complete" == r.readyState ? setTimeout(b, 0) : (setTimeout(function() {
                ...
                instagram: function() {
                    XF.loadScript("https://platform.instagram.com/" + XF.getLocale() + "/embeds.js", function() {
                        g(r).on("xf:reinit", function(a, b) {
                            q.instgrm && instgrm.Embeds.process(b instanceof g ? b.get(0) : b)
                        })
                    })
                },
                reddit: function() {
            ...
            setRelativeZIndex: function(a, b, c, f) {
                ...
                e || c ? a.each(function() {
                    var d = g(this);
                    "undefined" == typeof d.data("base-z-index") && d.data("base-z-index", parseInt(d.css("z-index"), 10) || 0);
                    d.css("z-index", d.data("base-z-index") + c + e)
                }) : a.css("z-index", "")
            },
            adjustHtmlForRte: function(a) {
                a =
                    a.replace(/<img[^>]+>/ig, function(b) {
                ...
                a = a.replace(/([\w\W]|^)<a\s[^>]*data-user-id="\d+"\s+data-username="([^"]+)"[^>]*>([\w\W]+?)<\/a>/gi, function(b, c, f, e) {
                    return c + ("@" == c ? "" : "@") + e.replace(/^@/, "")
                });
                a = a.replace(/(<img\s[^>]*)src="[^"]*"(\s[^>]*)data-url="([^"]+)"/gi, function(b, c, f, e) {
                    return c + 'src="' + e + '"' + f
                });
                a = g("<div />").html(a);
            ...
            requestAnimationTimeout: function(a, b) {
                ...
                b || (b = 0);
                var f = q.requestAnimationFrame || function(h) {
            ...
            getLocalLoadTime: function() {
                ...
                e || (q.performance && q.performance.timing && 0 !== q.performance.timing.requestStart ? (e = q.performance.timing, e = Math.floor((e.requestStart + e.responseStart) /
                    2E3)) : e = Math.floor((new Date).getTime() / 1E3) - 1, b.val(e + "," + a.now));
            ...
            smoothScroll: function(a, b, c, f) {
                ...
                if (a instanceof g || "string" === typeof a) {
                    ...
                    !0 ===
                        b && (b = e.length ? "#" + e.attr("id") : null)
                } else "number" === typeof a && (e = null, d = a);
                if (null === d) console.error("Invalid scroll position");
                else {
                    0 > d && (d = 0);
                    e = function() {
                        b && "pushState" in q.history && q.history.pushState({}, "", q.location.toString().replace(/#.*$/, "") + b)
                    };
                    if (f && (f = g(q).scrollTop(), a = f + g(q).height(), d >= f && d <= a)) {
                        e();
                        return
                    }
                    try {
                        e(), g("html, body").animate({
                            scrollTop: d
                        }, c, function() {
        ...
        (Object.create = function() {
                ...
                if ("object" == typeof b.__backup) {
                    ...
                    for (f in a)
                        if (a.hasOwnProperty(f)) {
                            if (c.prototype[a[f]]) throw Error("Method " + a[f] + " already exists on object. Aliases must be unique.");
            ...
            get: function(a) {
                return (a = (new RegExp("(^| )" + XF.config.cookie.prefix + a + "=([^;]+)(;|$)")).exec(r.cookie)) ? decodeURIComponent(a[2]) : null
            },
            getEncodedCookieValue: function(a, b, c, f) {
                var e = XF.config.cookie;
                return e.prefix + a + "=" + encodeURIComponent(b) + (void 0 === c ? "" : ";expires=" + c.toUTCString()) + (e.path ? ";path=" + e.path : "") + (e.domain ? ";domain=" + e.domain : "") + (f ? ";samesite=" + f : "") + (e.secure ? ";secure" : "")
            },
            getEncodedCookieValueSize: function(a, b, c, f) {
                return this.getEncodedCookieValue(a, b, c,
                    f).length
            },
            ...
            remove: function(a) {
                ...
                r.cookie = b.prefix + a + "=" + (b.path ? "; path=" + b.path : "") + (b.domain ? "; domain=" + b.domain : "") + (b.secure ? "; secure" : "") + "; expires=Thu, 01-Jan-70 00:00:01 GMT"
            },
            ...
            getKeyName: function(a) {
                return XF.config.cookie.prefix +
                    a
            },
            get: function(a) {
                var b = null;
            ...
            updateFallbackValue: function(a) {
                g.isEmptyObject(a) ? XF.Cookie.remove("ls") : XF.Cookie.set("ls", JSON.stringify(a))
            },
            supportsExpiryDate: function() {
                return !1
            }
            ...
            function a(e) {
                ...
                if (e.key === d) {
                    ...
                    if (h &&
                        h.event && (e = h.event, h = h.data || null, d = b[e])) {
                        f = e;
            ...
            return {
                ...
                trigger: function(e, d, h) {
                    !h && f && f == e || XF.LocalStorage.setJson("__crossTab", {
                        event: e,
                        data: d,
            ...
            function c() {
                var d = q.getComputedStyle(g("html")[0], ":after").getPropertyValue("content").replace(/"/g, "");
                if (f) {
                    if (d != f) {
                        var h = f;
                        f = d;
            ...
            var a = !1,
                ...
                k = function(v) {
                    e = XF.ajax("post", XF.canonicalizeUrl("job.php"), {
                        ...
                        y.more && y.ids && y.ids.length ? (y.status && g("#xfAutoBlockingJobStatus").text(y.status), setTimeout(function() {
                            k(y.ids)
                        }, 0)) : (m(), y.moreAuto && setTimeout(h, 100))
                    }, {
                        skipDefault: !0
                    }).fail(m)
                },
                m = function() {
                    ...
                    f--;
                    0 > f && (f = 0);
                    0 == f && (g(r).trigger("job:auto-blocking-complete"),
                        t());
                    e && e.abort();
                    e = null
                },
                ...
                n = function(v) {
                    v = XF.getOverlayHtml({
                        ...
                        dismissible: !1,
                        html: '<div class="blockMessage"><span id="' + v + '">' + XF.phrase("processing...") + "</span></div>"
                    });
            ...
            return {
                ...
                runAutoBlocking: function(v, y) {
                    ...
                    v.length && (f++, d || (d = n("xfAutoBlockingJobStatus")), d.show(), y || (y = XF.phrase("processing...")), g("#xfAutoBlockingJobStatus").text(y), k(v))
                },
                runManual: function(v) {
                    ...
                    if (y) {
                        if (null === v) w = null;
                            ...
                            var w = w || [];
                            "number" === typeof v ? w.push(v) : Array.isArray(v) && w.push.apply(w, v)
                        }
                        if (!a) {
                            a = !0;
                            p().show();
                            var u = function(B) {
                                    b = XF.ajax("post", y, B ? {
                                        ...
                                        A.jobRunner ?
                                            (g("#xfManualJobStatus").text(A.jobRunner.status || XF.phrase("processing...")), setTimeout(function() {
                                                u(B)
                                            }, 0)) : z()
                                    }, {
                                        skipDefault: !0
                                ...
                                z = function() {
                                    Array.isArray(w) && 0 == w.length ? l() : u(w ? w.shift() : null)
                                };
                            z()
                        }
                    }
            ...
            var a = XF.config.css,
                ...
                c = function(f, e, d) {
                    ...
                    var h = [],
                        k = [],
                        m;
                    for (m = 0; m < f.length; m++) b.hasOwnProperty(f[m]) || h.push(f[m]);
                    for (m = 0; m < e.length; m++) a.hasOwnProperty(e[m]) || k.push(e[m]);
                    var l = (h.length ? 1 : 0) + (k.length ?
                            1 : 0),
                        p = function() {
                            l--;
                            0 == l && d && d()
                        };
                    l ? (h.length && XF.loadScripts(h, function() {
                        g.each(h, function(n, t) {
                            b[t] = !0
                        });
                        p()
                    }), k.length && ((f = XF.config.url.css) ? (f = f.replace("__SENTINEL__", k.join(",")), g.ajax({
                        type: "GET",
                        url: f,
                        cache: !0,
                        global: !1,
                        ...
                        success: function(n) {
                            ...
                            t && (n = n.replace(/(url\(("|')?)([^"')]+)(("|')?\))/gi, function(x, v, y, w, u, z) {
                                w.match(/^([a-z]+:|\/)/i) || (w = t + w);
                                return v + w + u
                            }));
                        ...
                        p()
                    })) : (console.error("No CSS URL so cannot dynamically load CSS"), p()))) : d && d()
                };
            return {
                load: c,
            ...
            var a = 0,
                b, c = function() {
                    a++;
                    1 == a && (b || (b = g('<span class="globalAction"><span class="globalAction-bar"></span><span class="globalAction-block"><i></i><i></i><i></i></span></span>').appendTo("body")), b.addClassTransitioned("is-active"))
                },
                f = function() {
                    a--;
            ...
            var a, b, c, f, e, d, h = !1,
                ...
                l = function(n) {
                    ...
                    var t = n.length,
                        ...
                        v = new Date;
                    v.setHours(0, 0, 0, 0);
                    b + x > e && (v.getDay(), e = p(v, 1), c = p(v, 0), f = p(v, -1), d = p(v, -6));
                    for (var y = 0; y < t; y++) {
                        var w = n[y];
                        var u = g(w);
                        ...
                        var B = b - z + x;
                        var A = w.xfDynType; -
                        2 > B ? (B = z - (b + x), 60 > B ? "futureMoment" != A && (u.text(XF.phrase("in_a_moment")), w.xfDynType = "futureMoment") : 120 > B ? "futureMinute" != A && (u.text(XF.phrase("in_a_minute")), w.xfDynType = "futureMinute") : 3600 > B ? (z = Math.floor(B / 60), A !== "futureMinutes" + z && (u.text(XF.phrase("in_x_minutes", {
                            "{minutes}": z
                        })), w.xfDynType = "futureMinutes" + z)) : z < e ? "latertoday" != A && (u.text(XF.phrase("later_today_at_x", {
                            "{time}": u.attr("data-time-string")
                        })), w.xfDynType = "latertoday") : z < p(v, 2) ? "tomorrow" != A && (u.text(XF.phrase("tomorrow_at_x", {
                            "{time}": u.attr("data-time-string")
                        })), w.xfDynType = "tomorrow") : (604800 > B || (u.attr("data-full-date") ? u.text(XF.phrase("date_x_at_time_y", {
                            "{date}": u.attr("data-date-string"),
                            "{time}": u.attr("data-time-string")
                        })) : u.text(u.attr("data-date-string"))), w.xfDynType = "future")) : 60 >= B ? "moment" !== A && (u.text(XF.phrase("a_moment_ago")), w.xfDynType = "moment") : 120 >= B ? "minute" !== A && (u.text(XF.phrase("one_minute_ago")), w.xfDynType = "minute") : 3600 > B ? (z = Math.floor(B / 60), A !== "minutes" + z && (u.text(XF.phrase("x_minutes_ago", {
                            "{minutes}": z
                        })), w.xfDynType = "minutes" + z)) : z >= c ? "today" !== A && (u.text(XF.phrase("today_at_x", {
                            "{time}": u.attr("data-time-string")
                        })), w.xfDynType = "today") : z >= f ? "yesterday" !== A && (u.text(XF.phrase("yesterday_at_x", {
                            "{time}": u.attr("data-time-string")
                        })), w.xfDynType = "yesterday") : z >= d ? "week" !== A && (u.text(XF.phrase("day_x_at_time_y", {
                            "{day}": XF.phrase("day" + (new Date(1E3 * z)).getDay()),
                            "{time}": u.attr("data-time-string")
                        })), w.xfDynType = "week") : "old" !== A && (u.attr("data-full-date") ? u.text(XF.phrase("date_x_at_time_y", {
                            "{date}": u.attr("data-date-string"),
                            "{time}": u.attr("data-time-string")
                        })) : u.text(u.attr("data-date-string")), w.xfDynType = "old")
                    }
                },
                p = function(n, t) {
                    return Math.floor((new Date(n.valueOf())).setFullYear(n.getFullYear(), n.getMonth(), n.getDate() + t) / 1E3)
                };
            return {
                initialize: function() {
                    if (!h) {
                        ...
                        e = n.tomorrow;
                        d = n.week;
                        void 0 !== r.hidden ? (r.hidden || m(), g(r).on("visibilitychange", function() {
            ...
            var a, b, c = !1,
                ...
                d = 0,
                h, k = function() {
                    c && (!1 === q.navigator.onLine && (d++, 5 >= d && (h = setTimeout(k, 30))), d = 0, clearTimeout(h), g.ajax({
                ...
                m = function(l) {
                    l.csrf &&
                        (XF.config.csrf = l.csrf, g("input[name=_xfToken]").val(l.csrf));
                    if ("undefined" !== typeof l.user_id) {
                        var p = g(".js-activeUserChangeMessage");
                        l.user_id == XF.config.userId || p.length || XF.addFixedMessage(XF.phrase("active_user_changed_reload_page"), {
            ...
            return {
                initialize: function() {
                    q.addEventListener("popstate", function(e) {
                        e = e.state;
                        for (var d = !1, h = 0; h < f.length; h++) f[h](e, b, c) && (d = !0);
                        d || c.replace(/#.*$/, "") === q.location.href.replace(/#.*$/, "") || q.location.reload();
                        b = e;
                        c = q.location.href
                    })
                },
            ...
            var a = function(c) {
                    ...
                    !e || d && d == c.timeStamp || (f.data("proxy-handler-last", c.timeStamp), g.ajax({
                ...
                b = function(c) {
                    if (XF.config.enableRtnProtect && !c.isDefaultPrevented()) {
                        ...
                        if (e && (!e.match(/^[a-z]:/i) || e.match(/^https?:/i)) && !f.is("[data-fancybox]")) {
                            if (f.is("[rel~=noopener]")) {
                                var h = XF.browser;
                                if (h.chrome && 49 <= h.version || h.mozilla && 52 <= h.version || h.safari && 11 <= h.version) return
                            }
                            if (!(f.closest("[contenteditable=true]").length || (e = XF.canonicalizeUrl(e), (new RegExp("^[a-z]+://" + location.host + "(/|$|:)",
                                    "i")).test(e) || d && d == c.timeStamp || (f.data("blank-handler-last", c.timeStamp), h = navigator.userAgent, f = -1 !== h.indexOf("MSIE"), d = -1 !== h.indexOf("Safari") && -1 == h.indexOf("Chrome"), h = -1 !== h.indexOf("Gecko/"), c.shiftKey && h || d && (c.shiftKey || c.altKey) || f)))) {
                                if (d) f = g('<iframe style="display: none" />').appendTo(r.body), d = f[0].contentDocument || f[0].contentWindow.document, d.__href = e, e = g("<script />", d), e[0].text = "window.opener=null;window.parent=null;window.top=null;window.frameElement=null;window.open(document.__href).opener = null;",
                                    d.body.appendChild(e[0]), f.remove();
                                else {
                                    e = q.open(e);
                                    try {
                                        e.opener = null
            ...
            return {
                initLinkProxy: function() {
                    ...
                    g(r).on("click", c, a).on("focusin", c, function(f) {
                        f = g(this);
                        f.data("proxy-handler") || f.data("proxy-handler", !0).click(a)
                    })
                },
                initExternalWatcher: function() {
                    g(r).on("click", "a[target=_blank]", b).on("focusin", "a[target=_blank]", function(c) {
                        c = g(this);
        ...
        XF.create({
                    ...
                    if (a.length)
                        if (a.each(function() {
                            ...
                            this.getLinks().each(function() {
                                var f = g(this),
                                    e = f.attr("title");
                                e && f.attr("title", Mustache.render(e, c)).removeClass("is-hidden")
                            })
            ...
            __construct: function(a, b) {
                ...
                this.$container =
                    g('<div class="multiBar-container" />');
            ...
            hide: function() {
                if (this.shown) {
                    ...
                    var a = this;
                    this.$multiBar.removeClassTransitioned("is-active",
                        function() {
        ...
        XF.MultiBar.cache = {}, XF.showMultiBar = function(a, b) {
            ...
            var e = function(h) {
                ...
                c.show && h.show();
                c.afterShow && (k = g.Event(), c.afterShow(h, k), k.isDefaultPrevented())
            };
            if (c.cache && XF.loadMultiBar.cache[a]) e(XF.loadMultiBar.cache[a]);
                ...
                var d = function(h) {
                    if (h.redirect)
                        ...
                        else XF.ajax("get", h.redirect, function(k) {
                            d(k)
                        });
                    h.html && XF.setupHtmlInsert(h.html, function(k, m, l) {
                        var p = new XF.MultiBar(XF.getMultiBarHtml({
                            html: k,
                            title: m.title || m.h1
                        }), f);
                        c.init && c.init(p);
                        if (!c.cache) p.on("multibar:hidden", function() {
                            p.destroy()
                        });
                        l();
            ...
            __construct: function(a, b) {
                ...
                this.$container = g('<div class="overlay-container" />').html(this.$overlay);
                this.$container.data("overlay", this).xfUniqueId();
                var c = this;
                if (this.options.escapeClose) this.$container.on("keydown.overlay", function(f) {
                    27 === f.which && c.hide()
                });
                this.options.backdropClose && (this.$container.on("mousedown", function(f) {
                    c.$container.data("block-close", !1);
                    g(f.target).is(c.$container) || c.$container.data("block-close", !0)
                }), this.$container.on("click", function(f) {
                    g(f.target).is(c.$container) && (c.$container.data("block-close") || c.hide());
                    c.$container.data("block-close", !1)
                }));
            ...
            var a = 0,
                ...
                f = function() {
                    ...
                    XF.isRtl() && (XF.browser.chrome || XF.browser.mozilla || (e = "left"));
                    c.css("margin-" + e, d)
                };
            return {
                getOpenCount: function() {
        ...
        XF.showOverlay = function(a, b) {
            ...
            var f = function(d) {
                ...
                b.show && d.show();
                b.afterShow && (h = g.Event(), b.afterShow(d, h), h.isDefaultPrevented())
            };
            if (b.cache && XF.loadOverlay.cache[a]) f(XF.loadOverlay.cache[a]);
            else {
                var e = function(d) {
                    if (d.redirect)
                        if (b.onRedirect) b.onRedirect(d,
                            e);
                        else XF.ajax("get", d.redirect, function(h) {
                            e(h)
                        });
                    d.html && XF.setupHtmlInsert(d.html, function(h, k, m) {
            ...
            function a(u) {
                if (!l) {
                    ...
                    y || (y = XF.requestAnimationTimeout(function() {
                        y = null;
                        b();
                        f()
                    }, 200))
            ...
            function k(u) {
                u = g(u.target);
                u.is(".button--scroll") && 0 !== u.closest(".button--scroll").length && (l = !0, setTimeout(function() {
                    l = !1
                }, 500), c())
            }
            var m = null,
            ...
            function a(d) {
                d = g(d);
                1 < d.length ? d.each(function() {
                    a(this)
                }) : (d.is("[data-xf-key]") && b(d[0]), d.find("[data-xf-key]").each(function() {
                    b(this)
                }))
            }
            ...
            function b(d) {
                ...
                l = -1 !== l.indexOf("META");
                (p = 0 + p ? 1 : 0 + n ? 2 : 0 + l ? 4 : 0) ? XF.Keyboard.isStandardKey(m) ? (e[m] = e[m] || {}, e[m][p] = d) : console.warn("It is not possible to specify a keyboard shortcut using this key combination (%s)", h): e[k] = d
            }
            ...
            function c(d) {
                ...
                if (XF.Keyboard.isShortcutAllowed(r.activeElement) &&
                    (!e.hasOwnProperty(d.key) || 0 != (0 + d.ctrlKey ? 1 : 0 + d.altKey ? 2 : 0 + d.metaKey ? 4 : 0) || !f(e[d.key])) && e.hasOwnProperty(d.which)) {
                    var h = 0 + d.ctrlKey ? 1 : 0 + d.altKey ? 2 : 0 + d.metaKey ? 4 : 0;
            ...
            function f(d) {
                ...
                return d.length ? (XF.NavDeviceWatcher.toggle(!0), XF.isElementVisible(d) || d.get(0).scrollIntoView(!0), d.is(XF.getKeyboardInputs()) ? d.autofocus() : d.is("a[href]") ? d.get(0).click() : d.click(), !0) : !1
            }
            var e = {};
            return {
                initialize: function() {
                    g(r.body).onPassive("keyup",
                        c)
                },
            ...
            isShortcutAllowed: function(a) {
                switch (a.tagName) {
                    ...
                    case "BODY":
                        return !0;
                    default:
                        return XF.browser.msie && g(a).parents(".fr-element").length ? !1 : "true" === a.contentEditable ? !1 : !0
                }
            },
            ...
            function f(d) {
                ...
                h[0] !== k[0] || XF.isElementVisible(h) || (d = d.closest(".overlay-container.is-active"), d.length ? d.scrollTop(h.offset().top - d.offset().top + d.scrollTop() - 100) : (h[0].scrollIntoView(), q.scrollBy(0, -100)))
            }
            var e = {};
            return {
                initialize: function() {
        ...
        function() {
            return {
                initialize: function() {
                    g(r).on("xf:notice-change xf:layout", XF.proxy(this, "checkNotices"));
                    this.checkNotices()
                },
                checkNotices: function() {
                    var a = this.getBottomFixerNoticeHeight();
                    g(r).find("footer.p-footer").css("margin-bottom", a)
                },
                getBottomFixerNoticeHeight: function() {
                    var a = 0;
                    g(r).find(".js-bottomFixTarget .notices--bottom_fixer .js-notice").each(function() {
                        var b = g(this);
            ...
            function b() {
                return navigator.standalone || q.matchMedia("(display-mode: standalone), (display-mode: minimal-ui)").matches
            }

            function c() {
                k && (XF.ActionIndicator.show(), setTimeout(function() {
            ...
            function e(l, p) {
                if (navigator.serviceWorker.controller)
                    if ("string" !== typeof l || "" === l) console.error("Invalid message type:", l);
                    else {
            ...
            return {
                initialize: function() {
                    XF.PWA.isSupported() && (XF.config.skipServiceWorkerRegistration ? h = new Promise(function(l, p) {
                        p(Error("Service worker registration has been skipped"))
                    }) : (h = navigator.serviceWorker.register(a()), h.then(function(l) {
                        var p = XF.config.cacheKey;
                        l = l.active ? !1 : !0;
                        XF.LocalStorage.get("cacheKey") !== p && (l || e("updateCache"), XF.LocalStorage.set("cacheKey", p, !0))
                    }), h.catch(function(l) {
                    ...
                    }), navigator.serviceWorker.addEventListener("message", function(l) {
                        var p = l.data;
                        if ("object" !== typeof p || null === p) console.error("Invalid message:", p);
                        else if (l = p.type, p = p.payload,
                            "string" !== typeof l || "" === l) console.error("Invalid message type:", l);
                        else if ("object" !== typeof p || null === p) console.error("Invalid message payload:", p);
                        else {
                            var n = m[l];
                            "undefined" === typeof n ? console.error("No handler available for message type:", l) : n(p)
                        }
                    }), b() && (g(q).on("beforeunload", c), g(r).on("click", ".js-skipPwaNavIndicator", f))))
                },
        ...
        XF.Push = function() {
            ...
            function b() {
                XF.PWA.getRegistration().then(function(d) {
                    ...
                    XF.Push.isSubscribed ? (g(r).trigger("push:init-subscribed"), XF.config.userId && f(d) ? XF.Push.updateUserSubscription(d, "update") : (d.unsubscribe(), XF.Push.updateUserSubscription(d, "unsubscribe"))) : g(r).trigger("push:init-unsubscribed")
                })
            }

            function c(d) {
                var h =
                    "=".repeat((4 - d.length % 4) % 4);
            ...
            function f(d) {
                ...
                if (!(d instanceof ArrayBuffer)) throw Error("input must be an array buffer or convertable to it");
            ...
            return {
                ...
                hasUserPreviouslySubscribed: function(d) {
                    return XF.Push.getPushHistoryUserIds().hasOwnProperty(d ||
                        XF.config.userId)
                },
                ...
                handleUnsubscribeAction: function(d, h) {
                    XF.Push.isSubscribed && XF.PWA.getRegistration().then(function(k) {
                ...
                handleSubscribeAction: function(d, h, k) {
                    XF.Push.isSubscribed || Notification.requestPermission().then(function(m) {
                        if ("granted" !== m) console.error("Permission was not granted");
                        else {
                            var l = XF.Push.base64ToUint8(XF.config.pushAppServerKey);
                            XF.PWA.getRegistration().then(function(p) {
                                p.pushManager.subscribe({
                                    userVisibleOnly: !0,
                                    applicationServerKey: l
                                }).then(function(n) {
                                    XF.Push.updateUserSubscription(n,
                                        "insert");
                                    ...
                                    XF.config.publicMetadataLogoUrl && (n.icon = XF.config.publicMetadataLogoUrl);
                                    XF.config.publicPushBadgeUrl && (n.badge = XF.config.publicPushBadgeUrl);
                                    d || p.showNotification(XF.phrase("push_enable_notification_title"), n);
                ...
                handleToggleAction: function(d, h, k, m) {
                    XF.Push.isSubscribed ?
                        XF.Push.handleUnsubscribeAction(d, h) : XF.Push.handleSubscribeAction(!1, k, m)
                },
                updateUserSubscription: function(d, h) {
                    if ("update" !== h || !XF.Cookie.get("push_subscription_updated")) {
                        ...
                        g.ajax({
                            ...
                            data: {
                                endpoint: d.endpoint,
                                key: k ? btoa(String.fromCharCode.apply(null, new Uint8Array(k))) : null,
                                token: m ? btoa(String.fromCharCode.apply(null, new Uint8Array(m))) : null,
                                encoding: l,
                            ...
                            "update" === h && XF.Cookie.set("push_subscription_updated", "1")
                        })
                    }
                },
                isSupported: function() {
                    return XF.PWA.isSupported() && XF.config.enablePush && XF.config.pushAppServerKey && "PushManager" in q && "Notification" in q
                },
                base64ToUint8: c,
            ...
            function a(b) {
                g(b).find(".js-expandWatch:not(.is-expanded)").each(function() {
                    var c =
                        g(this),
                        ...
                        var e, d = 0,
                            h = function() {
                                var n = f.scrollHeight,
                                    t = f.offsetHeight;
                                0 == n || 0 == t ? 2E3 < d || (e && (clearTimeout(e), d += 200), e = setTimeout(h, d)) : n > t + 1 ? c.addClass("is-expandable") : c.removeClass("is-expandable")
                            };
                        h();
                        if (!c.data("expand-check-triggered") && (c.data("expand-check-triggered", !0), c.find("img").one("load", h), q.MutationObserver)) {
                            var k, m = !0,
                                l = function() {
                                    m = !1;
                                    h();
                            ...
                            var p = new MutationObserver(function(n) {
                                c.hasClass("is-expanded") ? p.disconnect() :
            ...
            return {
                watch: function() {
                    g(r).on("click", ".js-expandLink", function(b) {
                        g(b.target).closest(".js-expandWatch").addClassTransitioned("is-expanded", XF.layoutChange)
                    });
            ...
            function a() {
                function e(h) {
                    ...
                    var m = k.indexOf("\n"); - 1 !== m && (k = k.substring(0,
                        m), d = null === d ? k.length : d + k.length, d++, XF.UnfurlLoader.handleResponse(JSON.parse(k)), d < h.length && e(h))
                }
                if (b.length && !c) {
                    var d = null;
                    c = !0;
            ...
            return {
                activateContainer: function(e) {
                    ...
                    e.length && (e.each(function() {
                        var d =
                            g(this);
                        if (!1 === d.data("pending") || d.data("pending-seen")) return !0;
                ...
                handleResponse: function(e) {
                    ...
                    d.length && (e.success ? XF.setupHtmlInsert(e.html, function(h, k, m) {
                        d.replaceWith(h)
                    }) : (e = d.find(".js-unfurl-title a"), e.text(d.data("url")).addClass("bbCodePlainUnfurl").removeClass("fauxBlockLink-blockLink"), d.replaceWith(e)))
                }
            }
        }(), XF.Event = function() {
            var a = new XF.ClassMapper,
                ...
                f = XF.create({
                    ...
                    _init: function() {
                        var e = new g.Event("xf-" + this.eventType + ":before-init." + this.eventNameSpace),
                            d = !1;
                        this.$target.trigger(e, [this]);
                        e.isDefaultPrevented() || (d = this.init(), this.$target.trigger("xf-" + this.eventType + ":after-init." + this.eventNameSpace, [this, d]));
                        this.initialized = !0;
                        return d
                    },
                    _onEvent: function(e) {
                        var d = new g.Event("xf-" + this.eventType + ":before-" + this.eventType + "." + this.eventNameSpace);
                        this.$target.trigger(d, [this]);
                        if (!d.isDefaultPrevented()) {
                            if ("function" == typeof this[this.eventType]) d = this[this.eventType](e);
                            else if ("function" == typeof this.onEvent) d = this.onEvent(e);
                            else return console.error("You must provide a %1$s(e) method for your %1$s event handler", this.eventType, this.eventNameSpace), e.preventDefault(), !1;
                            this.$target.trigger("xf-" + this.eventType + ":after-" +
                                this.eventType + "." + this.eventNameSpace, [this, d, e])
                        }
                        return null
                    },
                    init: function() {
            ...
            return {
                watch: function(e) {
                    function d(h, k) {
                        ...
                        k = g(k);
                        return k.is("a") && !k.data("click-allow-modifier") && (h.ctrlKey || h.shiftKey || h.altKey || h.metaKey || 1 < h.which) || k.closest("[contenteditable=true]").length ? !1 : !0
                    }
                    e = String(e).toLowerCase();
                    b.hasOwnProperty(e) ||
                        (b[e] = !0, g(r).on(e, "[data-xf-" + e + "]", function(h) {
        ...
        XF.Element = function() {
                ...
                c = function(d) {
                    ...
                    if (d && d.getAttribute) {
                        ...
                        if (h) {
                            ...
                            var k = h.length;
                            d = g(d);
                            for (var m, l = 0; l < k; l++)(m = h[l]) && b(d, m, d.data("xf-" + m))
                        }
                    }
                },
                f = function(d) {
                    ...
                    1 < d.length ? d.each(function() {
                        ...
                        (d.is("[data-xf-init]") && c(d[0]), d.find("[data-xf-init]").each(function() {
                            c(this)
                        }))
                },
                e = XF.create({
            ...
            showResults: function(a, b, c, f) {
                ...
                if (b) {
                    this.resultsVisible = !1;
                    this.$results ? this.$results.hide().empty() : (this.$results = g("<ul />").css({
                        position: "absolute",
                        display: "none"
                    }).addClass("autoCompleteList " + this.options.wrapperClasses).attr("role", "listbox").appendTo(r.body), XF.setRelativeZIndex(this.$results, c, 1));
                    a = new RegExp("(" + XF.regexQuote(XF.htmlspecialchars(a)) + ")", "i");
                    for (e in b)
                        if (b.hasOwnProperty(e)) {
                            var d = b[e];
                            var h = g("<li />").css("cursor", "pointer").attr("unselectable", "on").attr("role", "option").mouseenter(XF.proxy(this, "resultMouseEnter"));
                            this.options.clickAttacher ? this.options.clickAttacher(h, XF.proxy(this, "resultClick")) : h.click(XF.proxy(this,
                                "resultClick"));
                            var k = {
                                icon: "",
                                text: "",
                            ...
                            } else if (m = d.text, k.text = XF.htmlspecialchars(d.text), "undefined" !== typeof d.desc && (k.desc = XF.htmlspecialchars(d.desc)), "undefined" !== typeof d.icon ? k.icon = g('<img class="autoCompleteList-icon" />').attr("src", XF.htmlspecialchars(d.icon)) : "undefined" !== typeof d.iconHtml && (k.icon = g('<span class="autoCompleteList-icon" />').html(d.iconHtml)), k.icon && (k.icon = k.icon[0].outerHTML), d.extraParams) {
                                var l =
                                    d.extraParams,
                                    p;
                                for (p in l)
                            ...
                            h.html(Mustache.render(this.options.displayTemplate, k)).appendTo(this.$results)
                        }
                    if (this.$results.children().length) {
                        this.selectResult(0, !0);
                        this.headerHtml && (h = g("<li />").addClass("menu-header menu-header--small").attr("unselectable",
                            "on").html(this.headerHtml), h.prependTo(this.$results));
                        if (!this.resizeBound) g(q).onPassive("resize", XF.proxy(this, "hideResults"));
                        this.$results.css({
                            top: "",
                            left: "",
                            right: "",
                        ...
                        var x = this.$results,
                            v = function(y) {
                                ...
                                if (!y) {
                                    ...
                                    XF.isRtl() && (y.right = g("html").width() - w.left - c.outerWidth(), y.left = "auto")
                                }
                                return y
                            };
                        this.stopScrollWatching();
            ...
            selectResult: function(a, b) {
                if (this.$results) {
                    ...
                    a.each(function(f) {
                        f == c ? g(this).addClass("is-selected") : g(this).removeClass("is-selected")
                    });
            ...
            insertResult: function(a) {
                ...
                if (b) {
                    ...
                    } else d = this.$input, d.autofocus(), -1 !== c && (d.setSelection(b.start, f.end), d.replaceSelectedText((this.options.keepAt ? this.options.at : "") + a + " ", "collapseToEnd"))
                }
            },
            show: function(a, b) {
                ...
                if (c)
                    if (this.visible = !0, this.ed) {
                        ...
                        this.results.showResults(a, b, f, function(k) {
                            if (!h || !h.getBoundingClientRect) return k = h.startContainer, {
                                top: (3 === k.nodeType ? g(k.parentNode) : g(k)).dimensions().bottom + 3,
                                left: e.left + 5
                            };
                            var m = h.cloneRange();
                            ...
                            return d.getResultPositionForSelection(m.left, m.bottom, h.getBoundingClientRect().left, k, e)
                        })
                    } else this.results.showResults(a, b, f, function(k) {
                        for (var m = g("<div />"), l = q.getComputedStyle(f[0]), p, n = "", t = 0; t < l.length; t++) p = l[t], n += p + ": " + l.getPropertyValue(p) + "; ";
                        m[0].style.cssText = n;
                        m.css({
                            position: "absolute",
                            height: "",
                        ...
                        m.remove();
                        return d.getResultPositionForSelection(l, p, n, k,
                            e)
                    })
            },
        ...
        }), XF.pageDisplayTime = Date.now(), g(XF.onPageLoad), g(q).on("pageshow", function() {
...
! function(e, l, m, u) {
    XF.AttributionClick = XF.Event.newHandler({
        ...
        click: function(a) {
            var b = this.options.contentSelector,
                c = e(b);
            c.length && (a.preventDefault(), XF.smoothScroll(c, b, XF.config.speed.normal))
        }
    });
    XF.LikeClick = XF.Event.newHandler({
        ...
        handleAjax: function(a) {
            ...
            var d = this.options.likeList ? XF.findRelativeIf(this.options.likeList, b) : e([]);
            "undefined" !== typeof a.html && d.length && (a.html.content ? XF.setupHtmlInsert(a.html, function(f, g) {
    ...
    XF.handleSwitchResponse = function(a, b, c) {
        if (b.switchKey) {
            var d = a.data("sk-" + b.switchKey),
                f = !1;
            if (d) {
                for (var g, h; g = d.match(/(\s*,)?\s*(addClass|removeClass|titleAttr):([^,]+)(,|$)/);)
                    if (d =
                        d.substring(g[0].length), h = e.trim(g[3]), h.length) switch (g[2]) {
                        case "addClass":
                            a.addClass(h);
                            break;
                        case "removeClass":
        ...
        b.text && (d = a.find(a.data("label")), d.length || (d = a), d.text(b.text), f && a.attr("title", b.text).removeAttr("data-original-title").trigger("tooltip:refresh"));
        if (b.message) {
            var k = c && b.redirect;
            XF.flashMessage(b.message,
                k ? 1E3 : 3E3,
                function() {
    ...
    XF.ScrollToClick = XF.Event.newHandler({
        ...
        init: function() {
            ...
            if (a && a.length)
                if (this.$scroll = a, !0 === b || "true" === b) a = a.attr("id"),
    ...
    XF.SwitchClick = XF.Event.newHandler({
        ...
        handleAjax: function(a) {
            var b = this.$target,
                ...
                d = this;
            b.trigger(c, a, this);
            c.isDefaultPrevented() || (a.html && a.html.content && this.options.overlayOnHtml ? XF.setupHtmlInsert(a.html, function(f, g) {
                ...
                f.find("form").on("ajax-submit:response", XF.proxy(d, "handleOverlayResponse"));
    ...
    XF.AlertsList = XF.Element.newHandler({
        ...
        markAllReadClick: function(a) {
            a.preventDefault();
            this._makeAjaxRequest(e(a.target).attr("href"), XF.proxy(this, "handleMarkAllReadAjax"))
        },
        ...
        toggleReadStatus: function(a, b) {
            var c = a.hasClass("is-unread"),
                ...
                g = d.data("content");
            c ? (a.removeClass("is-unread"), g = d.data("unread")) : b && (a.addClass("is-unread"), g = d.data("read"));
    ...
    XF.Preview = XF.Element.newHandler({
        ...
        preview: function(a) {
            ...
            XF.ajax("post", this.options.previewUrl,
                ...
                function(c) {
                    c.html && XF.setupHtmlInsert(c.html, function(d, f, g) {
    ...
    XF.ShareButtons = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.$target.find(a).each(function() {
                var c = e(this);
                b && XF.Element.applyHandler(c, "element-tooltip", {
                    element: "> span"
                });
                c.data("clipboard") && navigator.clipboard && c.removeClass("is-hidden")
            })
        },
        setupPageData: function() {
            this.options.pageTitle && this.options.pageTitle.length ? this.pageTitle = this.options.pageTitle : (this.pageTitle = e('meta[property="og:title"]').attr("content"), this.pageTitle || (this.pageTitle = e("title").text()));
            if (this.options.pageUrl && this.options.pageUrl.length) this.pageUrl = this.options.pageUrl;
            else {
                var a = this.$target.closest(".overlay");
                a.length && (this.pageUrl = a.data("url"));
                this.pageUrl || (this.pageUrl = e('meta[property="og:url"]').attr("content"));
                this.pageUrl || (this.pageUrl = l.location.href)
            }
            this.options.pageDesc && this.options.pageDesc.length ? this.pageDesc = this.options.pageDesc : (this.pageDesc = e('meta[property="og:description"]').attr("content"), this.pageDesc || (this.pageDesc = e("meta[name=description]").attr("content") ||
                ""));
            this.options.pageImage && this.options.pageImage.length ? this.pageImage = this.options.pageImage : (this.pageImage = e('meta[property="og:image"]').attr("content"), this.pageImage || (this.pageImage = XF.config.publicMetadataLogoUrl || ""))
        },
        focus: function(a) {
            ...
            if (!b.attr("href") && !b.is(".shareButtons-button--share")) {
                ...
                c =
                    c.replace("{url}", encodeURIComponent(this.pageUrl)).replace("{title}", encodeURIComponent(this.pageTitle)).replace("{desc}", encodeURIComponent(this.pageDesc)).replace("{image}", encodeURIComponent(this.pageImage));
                b.attr("href", c)
            }
        },
        click: function(a) {
            ...
            b.is(".shareButtons-button--share") || a.altKey || a.ctrlKey || a.metaKey || a.shiftKey || (b.data("clipboard") ? (a.preventDefault(), a = b.data("clipboard").replace("{url}",
                this.pageUrl).replace("{title}", this.pageTitle).replace("{desc}", this.pageDesc).replace("{image}", this.pageImage), navigator.clipboard.writeText(a).then(function() {
                XF.flashMessage(XF.phrase("link_copied_to_clipboard"), 3E3)
            })) : c && c.match(/^https?:/i) && (a.preventDefault(), l.open(c, "share", "toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=" + d + ",height=" + f + ",left=" + (screen.width - d) / 2 + ",top=" + (screen.height - f) / 2)))
        }
    });
    XF.ShareInput = XF.Element.newHandler({
        ...
        buttonClick: function(a) {
            ...
            navigator.clipboard.writeText(this.$input.val()).then(function() {
                XF.flashMessage(b.options.successText ? b.options.successText :
                    XF.phrase("text_copied_to_clipboard"), 3E3)
            })
        },
    ...
    XF.WebShare = XF.Element.newHandler({
        ...
        isSupported: function() {
            var a =
                XF.browser.os;
            return "share" in navigator && "https:" == l.location.protocol && ("android" == a || "ios" == a)
        },
        ...
        click: function(a) {
            ...
            if (this.fetchUrl) {
                ...
                XF.ajax("get", this.fetchUrl, {
                    ...
                    "ok" === c.status ? (b.setShareOptions(c), b.share()) : XF.redirect(b.options.url)
                }, {
                    skipDefault: !0,
                    skipError: !0,
                    global: !1
    ...
    XF.PushToggle = XF.Element.newHandler({
        ...
        init: function() {
            XF.Push.isSupported() ?
                "denied" === Notification.permission ? (this.updateButton(XF.phrase("push_blocked_label"), !1), console.error("Notification.permission === denied")) : this.registerWorker() : (this.updateButton(XF.phrase("push_not_supported_label"), !1), console.error("XF.Push.isSupported() returned false"))
        },
        ...
        registerWorker: function() {
            ...
            XF.Push.registerWorker(function() {
                e(m).on("push:init-unsubscribed", function() {
                    ...
                    } else a.getDismissCookie() ||
                        a.$target.closest(".js-enablePushContainer").xfFadeDown(XF.config.speed.fast, XF.proxy(a, "initLinks"))
                })
            })
        },
        initLinks: function() {
    ...
    XF.Reaction = XF.Element.newHandler({
        ...
        init: function() {
            if (this.$target.is("a") && this.$target.attr("href")) {
                ...
                var a =
                    e("#xfReactTooltipTemplate");
                a.length && (this.$tooltipHtml = e(e.parseHTML(a.html())), this.tooltip = new XF.TooltipElement(XF.proxy(this, "getContent"), {
        ...
        actionClick: function(a) {
            ...
            if (this.$target.data("tooltip:taphold") && this.$target.is(a.currentTarget)) this.$target.removeData("tooltip:taphold");
                ...
                this.loading = !0;
                var b = this;
                XF.ajax("post", e(a.currentTarget).attr("href"), XF.proxy(this, "actionComplete")).always(function() {
                    setTimeout(function() {
                        b.loading = !1
                    }, 250)
                })
            ...
            if (a.html) {
                ...
                XF.setupHtmlInsert(a.html, function(k, n, p) {
                    ...
                    var t = b.find(".js-reaction"),
                        ...
                        q = b.attr("href");
                    f && (q = q.replace(/(\?|&)reaction_id=\d+(?=&|$)/, "$1reaction_id=" + f), b.attr("href", q));
                    d ? (b.addClass("has-reaction"), b.removeClass("reaction--imageHidden"), c || (c = 1), b.removeClass("reaction--" +
                        c), b.addClass("reaction--" + d), b.data("reaction-id", d)) : (b.removeClass("has-reaction"), b.addClass("reaction--imageHidden"), c && (b.removeClass("reaction--" + c), b.addClass("reaction--" + k.data("reaction-id")), b.data("reaction-id", 0)));
                    t.replaceWith(n);
                    r && p && r.replaceWith(p)
                });
                var h = this.options.reactionList ? XF.findRelativeIf(this.options.reactionList, b) : e([]);
                "undefined" !== typeof a.reactionList && h.length && (a.reactionList.content ? XF.setupHtmlInsert(a.reactionList, function(k, n) {
    ...
    XF.BookmarkClick = XF.Event.newHandler({
        ...
        handleSwitchClick: function(a) {
            ...
            a.html ? XF.setupHtmlInsert(a.html, function(d, f, g) {
                b.tooltip.requiresLoad() && (b.$tooltipHtml = d, b.tooltip.setLoadRequired(!1));
                c()
            }) : c()
        },
        ...
        loadResults: function() {
            if (!this.loading) {
                ...
                XF.ajax("get", XF.canonicalizeUrl("index.php?account/bookmarks-popup"), {
                    ...
                    c.html && (b.$showAllLinkTarget && c.showAllUrl && b.$showAllLinkTarget.attr("href", c.showAllUrl), XF.setupHtmlInsert(c.html, function(d, f) {
    ...
    XF.ContentVote = XF.Element.newHandler({
        ...
        handleAjax: function(a) {
            ...
            if (this.options.contentId) {
                var b = e('.js-contentVote[data-content-id="' + this.options.contentId +
                        '"]'),
                    c = this,
                    d = this.$target;
                b.each(function() {
                    if (d[0] !== this) {
                        var f = e(this);
                        f.is('[data-xf-init~="content-vote"]') ? XF.Element.getHandler(f, "content-vote").updateData(a) : c.updateDisplay(f, a)
                    }
                })
            }
        },
...
! function(e, p, q) {
        ...
        click: function(a) {
            ...
            if (b)
                if (d) {
                    ...
                    setTimeout(function() {
                        var h = {};
                        g ? h = b.closest(g).find("input, select, textarea").serializeArray() : h[b.attr("name")] = b.prop("checked") ? b.attr("value") : f;
                        XF.ajax("POST", d, h)
                    }, 0)
                } else c ? ((a = c.data("submit-click-timer")) && clearTimeout(a), c.one("ajax-submit:complete", function(h, k, m) {
                        if (k.errors) b.prop("checked", b.prop("checked") ? "" : "checked");
    ...
    XF.AjaxSubmit = XF.Element.newHandler({
        ...
        submit: function(a) {
            ...
            if (!(this.$submitButton && this.$submitButton.data("prevent-ajax") || XF.debug.disableAjaxSubmit))
                if (this.submitPending) a && a.preventDefault();
                    ...
                    setTimeout(function() {
                        k.submitPending = !0;
                        var m = XF.getDefaultFormData(c, b, k.options.jsonName, k.options.jsonOptIn);
                        k.disableButtons();
                        XF.ajax(h.method, h.action, m, h.successCallback, h.ajaxOptions).always(function() {
                            k.$submitButton = null;
                            setTimeout(function() {
                                k.submitPending = !1;
                                k.enableButtons()
        ...
        submitResponse: function(a, b, c) {
            if ("object" != typeof a) XF.alert("Response was not JSON.");
                ...
                if (!d.isDefaultPrevented()) {
                    ...
                    if (a.errorHtml) b.trigger(d,
                        a, this), d.isDefaultPrevented() || XF.setupHtmlInsert(a.errorHtml, function(l, n) {
                        n = n.h1 || n.title || XF.phrase("oops_we_ran_into_some_problems");
                        XF.overlayMessage(n, l)
                    }), g = !0;
                    else if (a.errors) b.trigger(d, a, this), d.isDefaultPrevented() || XF.alert(a.errors), g = !0;
                        ...
                        }), f = !0) : XF.redirect(a.redirect) : (XF.flashMessage(a.message, 3E3), f = !0), k &&
                    ...
                    b.trigger(d, a, this);
                    d.isDefaultPrevented() || this.options.resetComplete &&
                        !g && b[0].reset()
                }
            }
        },
        doSubmitReplace: function(a, b) {
            ...
            if (!g.length) return console.error("Could not find old selector '" + c + "'"), !1;
            var f = a.is(d) ? a : a.find(d).first();
            if (!f.length) return console.error("Could not find new selector '" + d + "'"), !1;
            this.options.showReplacement ? (f.hide().insertAfter(g),
                g.xfFadeUp(null, function() {
                    g.remove();
                    f.length && (XF.activate(f), b(!1));
                    f.xfFadeDown(null, XF.layoutChange)
                })) : (f.insertAfter(g), g.remove(), f.length && (XF.activate(f), b(!1)), XF.layoutChange());
            return !0
        },
    ...
    XF.ChangeSubmit = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.$target.find("[data-force-change-submit]").click(function(b) {
                a.hasUnsavedChanges && (b.stopPropagation(), b.stopImmediatePropagation(), a.$clickOnSuccessfulSave = e(b.target), a.triggerSubmit())
            })
        },
        initForm: function() {
        ...
        change: function(a) {
            ...
            this.validateGroup(e(a.target).data("group")) && (this.hasPendingChanges = !0, this.scheduleSubmit())
        },
    ...
    XF.AutoComplete = XF.Element.newHandler({
        ...
        load: function() {
            ...
            "" == this.loadVal ? this.hideResults() : this.loadVal == a || this.loadVal.length < this.options.minLength || (b[this.options.queryKey] = this.loadVal, "" != this.options.extraFields && e(this.options.extraFields).each(function() {
                b[this.name] =
                    e(this).val()
        ...
        getPartialValue: function() {
            ...
            var b = a.lastIndexOf(this.options.multiple);
            return -1 == b ? e.trim(a) : e.trim(a.substr(b + this.options.multiple.length))
        }
    });
    ...
    XF.SelectPlus = XF.Element.newHandler({
        ...
        checkboxEnter: function(a) {
            this.isActive && (this.lastEntered = this.$checkboxes.index(e(a.delegateTarget).find("input:checkbox").eq(0)),
                this.isShifted && this.redrawHover())
        },
        keydown: function(a) {
            "Shift" == a.key && XF.Keyboard.isShortcutAllowed(q.activeElement) && (this.isShifted = !0, this.redrawHover())
        },
        keyup: function(a) {
            "Shift" == a.key && this.isShifted && (this.isShifted = !1, this.redrawHover())
        },
        getShiftItems: function(a, b) {
            return null !== b && null !== this.lastSelected ? (a = a.slice(Math.min(b, this.lastSelected), Math.max(b, this.lastSelected) + 1), this.debug("shiftItems: %o", a), a) : e()
        },
        setActive: function(a) {
            var b = this.isActive;
            this.isActive = a ? !0 : 0 < this.$checkboxes.filter(":checked").length;
            this.deployMultiBar();
            this.isActive != b && (this.debug("setActive: %s", this.isActive), this.$target.trigger(this.isActive ? "selectplus:activate" : "selectplus:deactivate", [this]).toggleClassTransitioned(this.options.activeClass, this.isActive), e(q.body).toggleClassTransitioned("is-spDocTriggered", this.isActive))
        },
        redrawSelected: function() {
            ...
            this.$checkboxes.each(function(b) {
                ...
                b.toggleClassTransitioned(a.options.checkedClass,
                    d);
                c.data("check-state") != d && b.trigger("selectplus:toggle-item", [this, d]);
    ...
    XF.DescLoader = XF.Element.newHandler({
        ...
        onLoad: function(a) {
            ...
            a.description ? XF.setupHtmlInsert(a.description, function(c, d, g) {
        ...
        XF.Element.newHandler({
            ...
            init: function() {
                ...
                if (a.is(":radio")) {
                    ...
                    a.closest("select").on("change", function(f) {
                        f = e(this);
                        var h = XF.Element.getHandler(f.find("option:selected").first(), "disabler");
                        !f.find("option:selected").first().is(g.$target) && h && h.getOption("container") === g.options.container || g.recalculate(!1)
                    })
            ...
            recalculate: function(a, b) {
                var c = this.$container,
                    ...
                    h = this,
                    k = function() {
                        !b && h.options.autofocus && c.find("input:not([type=hidden], [type=file]), textarea, select, button").not(d).first().autofocus()
                    };
                d.is(":enabled") && (d.is(":checked") && !this.options.invert || this.options.invert && !d.is(":checked")) ? (c.prop("disabled", !1).removeClass("is-disabled"), g.prop("disabled", !1).removeClass("is-disabled").each(function(m, l) {
                    m = e(l);
                    m.is("select.is-readonly") && m.prop("disabled", !0)
                }).trigger("control:enabled"), this.options.hide ? (a ? c.show() : c.slideDown(f, function() {
                    XF.layoutChange();
                    k()
                }), c.trigger("toggle:shown"), XF.layoutChange()) : a || k()) : (this.options.hide && (a ? c.hide() : c.slideUp(f, XF.layoutChange), c.trigger("toggle:hidden"),
                    XF.layoutChange()), c.prop("disabled", !0).addClass("is-disabled"), g.prop("disabled", !0).addClass("is-disabled").trigger("control:disabled").each(function(m, l) {
                    m = e(l);
                    l = m.data("disabled");
    ...
    XF.FieldAdder = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.$target.on("keypress change paste input", function(b) {
                e(b.target).prop("readonly") || a.cloned || (a.cloned = !0, a.$clone || (a.$clone = a.$target.clone()), a.$target.off(b), a.create())
            })
        },
        create: function() {
            if (!this.created && (this.created = !0, 0 != this.options.remaining)) {
                ...
                if (this.options.incrementFormat) {
                    var c = new RegExp(b + XF.regexQuote(a).replace("\\{counter\\}", "(\\d+)"));
                ...
                this.$clone.find("input, select, textarea").each(function() {
                    var d = e(this);
                    d.is("select") ? d.find("option").each(function() {
                        e(this).prop("selected",
    ...
    XF.FormSubmitRow = XF.Element.newHandler({
        ...
        init: function() {
            if (XF.config.enableFormSubmitSticky) {
                ...
                b.length ? (this.$container = b, this.topOffset = this.options.topOffset, this.$fixEl = a.find(this.options.fixedChild), e(p).on("scroll", XF.proxy(this, "onScroll")).on("resize", XF.proxy(this, "recalcAndUpdate")), b = XF.getFixedOffsetParent(a), b.is("html") || (this.$fixedParent = b, b.on("scroll", XF.proxy(this, "onScroll"))), e(q.body).on("xf:layout",
        ...
        getScrollTop: function() {
            return this.$fixedParent ? this.$fixedParent.scrollTop() : e(p).scrollTop()
        },
        update: function() {
            var a = XF.browser.ios || XF.browser.android ? p.innerHeight : this.winHeight;
    ...
    XF.MinLength = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.$toggleTarget = this.options.toggleTarget ? XF.findRelativeIf(this.options.toggleTarget, this.$target) : e([]);
    ...
    XF.TextAreaHandler = XF.Element.newHandler({
        ...
        initialized: !1,
        init: function() {
            this.options.autoSize && (this.$target[0].scrollHeight ? this.setupAutoSize() :
                (this.$target.one("focus control:enabled control:disabled", XF.proxy(this, "setupDelayed")), this.$target.onWithin("toggle:shown overlay:shown tab:shown quick-edit:shown", XF.proxy(this, "setupDelayed"))), this.$target.on("autosize", XF.proxy(this, "update")));
    ...
    XF.PermissionMatrix = XF.Element.newHandler({
        ...
        update: function() {
            ...
            var a = this.$target.find(this.options.inputSelector + ":checked").val(); - 1 < e.inArray(a,
                this.values) && (this.currentClass = this.options.classPrefix + this.options.permissionType + "-" + a, this.$parentRow.addClass(this.currentClass))
        }
    });
    XF.MultiCheck = XF.Event.newHandler({
        ...
        init: function() {
            ...
            this.currentValue = 0 < e.inArray(a, this.values) ? this.values[-1] :
                this.values[0]
        },
        click: function(a) {
    ...
    XF.NumberBox = XF.Element.newHandler({
        ...
        createButton: function(a) {
            a = e("<button />").attr("type", "button").attr("tabindex", "-1").addClass("inputGroup-text").addClass("inputNumber-button").addClass("inputNumber-button--" +
                a).addClass("js-" + a).attr("data-dir", a).attr("title", XF.phrases["number_button_" + a] || a).attr("aria-label", XF.phrases["number_button_" + a] || a);
        ...
        setupButton: function(a, b) {
            a.on("focus", XF.proxy(this, "buttonFocus")).on("click", XF.proxy(this, "buttonClick")).on("mousedown touchstart", XF.proxy(this, "buttonMouseDown")).on("mouseleave mouseup touchend",
                XF.proxy(this, "buttonMouseUp")).on("touchend", function(c) {
                c.preventDefault();
                e(this).click()
            }).insertAfter(b)
        },
        ...
        stepFallback: function(a) {
            if (!this.$textInput.prop("readonly")) {
                ...
                if (Math.round(d) !== d) {
                    var k = 0;
                    c = c.split(".");
                    h ? k = c[1] ? c[1].length : 0 : Math.floor(f) !== f && (k = f.toString().split(".")[1].length || 0);
                    d = d.toFixed(k)
                }
                null !== a && d < a && (d = a);
                null !== g && d > g && (d = g);
        ...
        supportsStepFunctions: function() {
            ...
            return XF.browser.msie || XF.browser.edge || a.prop("disabled") || a.prop("readonly") ||
                this.$target.data("step") || "any" === a.attr("step") ? !1 : "function" === typeof a[0].stepUp && "function" === typeof a[0].stepDown
        }
    });
            ...
            if (!a.validatedValue ||
                ...
                if (!a.inputValid && b) {
                    if ("object" == typeof b)
                        ...
                        else c = "<ul>", e.each(b, function(g, f) {
                            c += "<li>" + f + "</li>"
                        }), c += "</ul>";
                    else c = b;
        ...
        update: function() {
            ...
            this.$checkboxes.each(function() {
                ...
                a.find('option[value="' + this.value + '"]').each(function() {
                    ...
                    !c && g && (d.prop("selected", !1), h.attr("multiple") || h.find("option:enabled").first().prop("selected", !0), k = !0);
                    k && b.push(h[0])
                })
            });
...
! function(f, m, q) {
    ...
    XF.Inserter = XF.create({
        ...
        onLoad: function(a) {
            if (a.html) {
                ...
                XF.setupHtmlInsert(a.html, function(h, k, l) {
                    ...
                    b._applyChange(h, c.append, XF.proxy(b,
                        "_applyAppend"));
        ...
        _applyChange: function(a, b, c) {
            if (b && b.length) {
                b = b.split(",");
                for (var d, e, g, h = 0; h < b.length; h++) d = b[h].split(" with "), e = f.trim(d[0]), g = d[1] ? f.trim(d[1]) : e, e.length && g.length && (d = f(e).first(), g = a.is(g) ? a : a.find(g).first(), c(e, d, g))
            }
        },
    ...
    XF.MenuClick = XF.Event.newHandler({
        ...
        open: function(a) {
            ...
            if (!this.isOpen() && !b.hasClass("is-disabled")) {
                ...
                this.$target.hasFixableParent() && (this.scrollFunction =
                    ...
                    }, b.addClass("menu--potentialFixed"), f(m).onPassive("scroll", this.scrollFunction));
                ...
                if (b.data("href")) {
                    if (!b.data("menu-loading")) {
                        ...
                        XF.ajax("get", b.data("href"), {}, function(l) {
                            k && b.data("href", !1);
                            l.html && XF.setupHtmlInsert(l.html, function(n, p,
                                r) {
                                (p = b.data("load-target")) ? b.find(p).first().empty().html(n): b.html(n);
        ...
        repositionFixed: function(a) {
            ...
            if (a && XF.isIOS()) {
                ...
                if (d && this.menuRef.left == d[0] && this.menuRef.width == d[1]) {
                    ...
                    a && clearTimeout(a);
                    "fixed" == e && e != b.css("position") ? (g = {
                        "transition-property": "none",
                        "transition-duration": "0s"
                    }, g = this.getVerticalFixedPosition(d, g)) : "absolute" == e && (g = {
                        "transition-property": "none",
                        "transition-duration": "0s"
                    }, g = this.getVerticalAbsolutePosition(d,
                        g));
        ...
        getHorizontalPosition: function(a, b) {
            var c = !1,
                d = 0;
            this.menuWidth > a.width ? d = this.menuRef.left - a.left : this.menuRef.left + this.menuRef.width / 2 > a.width * this.options.directionThreshold ? (d = 0 - this.menuWidth + this.menuRef.width, c = !0) : this.menuRef.width > this.menuWidth && (d = Math.floor((this.menuRef.width - this.menuWidth) /
                2));
            ...
            a = Math.min(this.arrowRef.left - this.menuRef.left + this.arrowRef.width / 2 - d, this.menuWidth - 20);
        ...
        keyboardEvent: function(a) {
            if (("ArrowUp" == a.key || "ArrowDown" == a.key) && XF.Keyboard.isShortcutAllowed(q.activeElement) && f(q.activeElement).closest(".menu").get(0) == this.$menu.get(0)) {
    ...
    XF.MenuWatcher =
        function() {
                    ...
                    if (!c) {
                        ...
                        a.each(function() {
                            var n = f(this).data("menu-trigger"),
                                p = n ? n.$target : null;
                            l.closest(this).length || p && l.closest(p).length || n && n.close()
                        });
                        c = !1
                    }
                };
            return {
                onOpen: function(k, l) {
                    b || (b = f('<div class="menuOutsideClicker" />').on("click", e).insertBefore(k));
                    a.length || (f(q).on("click", e), f(m).onPassive("resize", g), l && b.addClass("is-active"));
                    a = a.add(k)
                },
                onClose: function(k) {
                    a =
                        a.not(k);
                    a.length || (f(q).off("click", e), f(m).offPassive("resize", g), b && b.removeClass("is-active"));
                    h(k)
                },
                closeAll: function() {
                    c = !0;
    ...
    XF.MenuBuilder = {
        ...
        dataList: function(a,
            ...
            b.closest(".dataList-row").find(".dataList-cell--responsiveMenuItem").each(function() {
                f(this).clone().children().each(function() {
                    var e = f(this);
                    e.is("a") ? e.removeClass().addClass("menu-linkRow") : e.wrap('<div class="menu-row"></div>');
                    d.append(e)
                })
            });
            XF.activate(d)
    ...
    XF.OffCanvasBuilder = {
        navigation: function(a, b) {
            ...
            f(".js-offCanvasNavSource .p-navEl").each(function() {
                var d = f(this),
                    ...
                    h = d.find("[data-menu]");
                d.data("has-children") && !h.length && (d = d.find('[data-xf-click~="menu"]').first().data("xf-click-handlers")) && d.menu && (h = d.menu.$menu);
                if (g.length) {
                    ...
                    !k.is("a") && h.length && k.attr("data-xf-click", "menu-proxy").attr("data-trigger", "< :up | .offCanvasMenu-link--splitToggle");
                    d.html(k);
                    e && (g.addClass("is-selected"), d.addClass("is-selected"));
                    g.html(d);
                    if (h.length) {
                        k = f('<a class="offCanvasMenu-link offCanvasMenu-link--splitToggle" data-xf-click="toggle" data-target="< :up :next" role="button" tabindex="0" />');
                        ...
                        h.find(".menu-linkRow").each(function() {
                            var n =
                                f(this),
                                p = f("<li />");
                            p.html(n.clone().removeClass("menu-linkRow").addClass("offCanvasMenu-link"));
                            l.append(p)
                        });
                        g.append(l)
                    }
        ...
        sideNav: function(a, b) {
            var c = a.find(".offCanvasMenu-content"),
                d = b.$target;
            c.find("[data-menu-close]").length || (b = c.find(".block-header").first(), b.length || (b = f('<div class="offCanvasMenu-header offCanvasMenu-header--separated offCanvasMenu-shown" />'), b.html(d.html()), c.prepend(b)), b.append('<a class="offCanvasMenu-closer" data-menu-close="true" role="button" tabindex="0" />'));
        ...
        XF.Event.newHandler({
            ...
            show: function() {
                if (this.overlay) this.overlay.show();
                    ...
                    this.options.followRedirects && (b.onRedirect = function(c, d) {
                        a.options.forceFlashMessage ? XF.flashMessage(c.message, 1E3, function() {
            ...
            getOverlayHtml: function() {
                ...
                c && c.length || (a = a.attr("href")) && "#" == a.substr(0, 1) && (c = f(a).eq(0));
    ...
    XF.ToggleClick = XF.Event.newHandler({
        ...
        init: function() {
            this.$toggleTarget =
                XF.getToggleTarget(this.options.target, this.$target);
        ...
        load: function() {
            var a = this.toggleUrl,
                b = this;
            a && !this.loading && (this.loading = !0, XF.ajax("get", a, function(c) {
                c.html && XF.setupHtmlInsert(c.html, function(d, e, g) {
                    if (e = b.$toggleTarget.data("load-selector")) e = d.find(e).first(), e.length && (d = e);
                    b.ajaxLoaded = !0;
        ...
        hide: function(a) {
            if (this.isVisible() && !this.isTransitioning()) {
                ...
                this.$toggleParent && this.$toggleParent.removeClassTransitioned(b,
                    this.inactiveTransitionComplete, a);
        ...
        show: function(a) {
            if (!this.isVisible() && !this.isTransitioning() && !this.getOtherToggles().filter(".is-transitioning").length)
                if (this.toggleUrl && !this.ajaxLoaded) this.load();
                    ...
                    this.closeOthers();
                    var b = this.options.activeClass;
                    this.$toggleParent && this.$toggleParent.addClassTransitioned(b, this.activeTransitionComplete,
                        a);
        ...
        getOtherToggles: function() {
            ...
            return a && a.length ? a.find("[data-xf-click~=toggle]").not(this.$target[0]) : f([])
        }
    });
    ...
    XF.ToggleStorageDataInstance = XF.create({
        ...
        get: function(a, b, c) {
            ...
            if (!d && c[0] + c[1] < g) return delete this.dataCache[a][b],
        ...
        init: function() {
            ...
            if (a.length) {
                ...
                a.on("mousedown.horizontalScroller", function(l) {
                    l.button || (b = l.clientX, c = !1, l.preventDefault(), XF.isEventTouchTriggered(l) && (l = f(q.activeElement), l.is(":input") && l.blur()), f(m).on("mouseup.horizontalScroller", function(n) {
                        f(m).off(".horizontalScroller");
                        c && n.preventDefault()
                    }).on("mousemove.horizontalScroller", function(n) {
                        var p = b - n.clientX;
                        0 != p && (d.move(p) && (c = !0), b = n.clientX)
                    }))
                }).on("click.horizontalScroller",
                    function(l) {
                        c && (l.preventDefault(), l.stopImmediatePropagation(), c = !1)
                    }).on("scroll.horizontalScroller", XF.proxy(this, "updateScroll")).on("tab:click.horizontalScroller", function(l) {
                    c && l.preventDefault()
                });
                var e = XF.measureScrollBar(null, "height");
                a.addClass("is-calculated");
                0 != e && a.css("margin-bottom", parseInt(a.css("margin-bottom"), 10) - e + "px");
                e = this.options.actionClass;
                this.$goStart = f('<i class="' + e + " " + e + '--start" aria-hidden="true" />').click(function() {
                    d.step(-1)
                }).insertAfter(a);
                this.$goEnd = f('<i class="' +
                    e + " " + e + '--end" aria-hidden="true" />').click(function() {
                    d.step(1)
                }).insertAfter(a);
                this.updateScroll();
    ...
    XF.ResponsiveDataList = XF.Element.newHandler({
        ...
        processRow: function(a, b) {
            ...
            a.find(this.options.rowCells).each(function() {
                ...
                if (b) {
                    var g = d[c];
                    g && g.length && !e.data("hide-label") ? e.attr("data-cell-label", g) : e.removeAttr("data-cell-label")
    ...
    XF.StickyHeader = XF.Element.newHandler({
        ...
        init: function() {
            ...
            if (a) {
                ...
                (d = c.match(/ Edge\/(\d+)/)) && 17 <= parseInt(d[1], 10) && XF.isRtl() && (b = !0, a = !1)
            }
            this.supportsSticky =
                a;
            this.stickyBroken = b;
        ...
        update: function() {
            (this.windowTooSmall = f(m).height() < this.options.minWindowHeight) ? !1 !== this.active && this._disable(): this.active || this._enable()
        },
        _enable: function() {
            this.active = !0;
            var a = this.$target,
            ...
            if (this.supportsSticky) {
                var d = !1,
                    ...
                    h, k = function(l) {
                        ...
                        n < e || n == e && 0 < m.scrollY ? d || (a.addClass(b), XF.layoutChange(), d = !0) : d && (g && l ? (clearTimeout(h), h = setTimeout(function() {
                            k(!1)
                        }, 200)) : (a.removeClass(b), XF.layoutChange(), d = !1))
                    };
        ...
        _disable: function() {
            ...
            this.supportsSticky ? f(m).off("scroll.sticky-header") : a.trigger("sticky_kit:detach").removeData("sticky_kit");
    ...
    XF.Tabs = XF.Element.newHandler({
        ...
        activateTarget: function(a) {
            ...
            if (a) {
                ...
                if (c)
                    for (c = 0; c < b.length; c++) b.eq(c).is(a) && (this.activateTab(c), d = !0)
            }
        ...
        activateTab: function(a) {
            ...
            b.length && c.length ? (this.$tabs.filter("." + d).removeClass(d).attr("aria-selected", "false").trigger("tab:hidden"), this.$panes.filter("." + d).removeClass(d).attr("aria-expanded", "false").trigger("tab:hidden"), b.addClass(d).attr("aria-selected",
                "true").trigger("tab:shown"), c.addClass(d).attr("aria-expanded", "true").trigger("tab:shown"), XF.layoutChange(), c.data("href") && !c.data("tab-loading") && (c.data("tab-loading", !0), XF.ajax("get", c.data("href"), {}, function(e) {
                c.data("href", !1);
                if (e.html) {
                    var g = c.data("load-target"),
                        h = c.data("source-selector");
                    h && (e.html.content = f(e.html.content).find(h));
                    g ? XF.setupHtmlInsert(e.html, c.find(g)) : XF.setupHtmlInsert(e.html, c)
                }
            }).always(function() {
        ...
        tabClick: function(a) {
            ...
            if (-1 == c) console.error("Did not find clicked element (%o) in tabs", b);
                ...
                if (!d.isDefaultPrevented()) {
                    ...
                    if (this.options.state) switch (a = m.location.href.split("#")[0], b.attr("id") ? (a = a + "#" + b.attr("id"), b = {
                        id: b.attr("id")
                    }) : b = {
                        offset: c
                    }, this.options.state) {
    ...
    XF.QuickSearch = XF.Element.newHandler({
        ...
        updateSelectWidth: function() {
            if (this.$select.length) {
                var a = f("<span />").addClass(this.$select.attr("class")).addClass("input--select"),
    ...
    XF.TouchProxy = XF.Element.newHandler({
        ...
        init: function() {
            var a = this;
            if ("InputDeviceCapabilities" in m || "sourceCapabilities" in UIEvent.prototype) this.$target.click(function(c) {
                var d = c.originalEvent;
                d && d.sourceCapabilities && d.sourceCapabilities.firesTouchEvents &&
                    a.handleTapEvent(c)
            });
    ...
    XF.DuplicatorClick = XF.Event.newHandler({
        ...
        click: function(a) {
            this.$targetElement.length && (a = this.$targetElement.clone(!0).insertAfter(this.$targetElement), XF.layoutChange(), this.$targetElement.closest("[data-xf-init~=list-sorter]").length && f(m).trigger("listSorterDuplication", a))
        }
    });
    ...
    f(q).on("xf:page-load-complete", function() {
        ...
        a && (a = a ? f("#" + a) : f(), a.length && (a = a.closest("[data-toggle-wrapper]"), a.length && (a = a.find('[data-xf-click~="toggle"]').first(), a.length && (a = XF.Event.getElementHandler(a, "toggle", "click")) && a.show(!0))))
    })
}(jQuery, window, document);
...
! function(f, m, p) {
    XF.TooltipElement = XF.create({
            ...
            if (!this.shown)
                if (this.shown = !0, this.loadRequired) this.loadContent();
                    ...
                    var a = this.getTooltip(),
                        b = this;
                    this.reposition();
                    f(m).on("resize.tooltip-" + a.xfUniqueId(), XF.proxy(this, "reposition"));
        ...
        hide: function() {
            if (this.shown) {
                ...
                var a = this.$tooltip;
                a && (a.stop().fadeOut("fast").trigger("tooltip:hidden"), f(m).off("resize.tooltip-" + a.xfUniqueId()))
            }
        },
        toggle: function() {
        ...
        reposition: function() {
            ...
            if (!a) console.error("No tooltip positioner");
                ...
                b = a.outerWidth();
                k = a.outerHeight();
                "top" == d && c.top - k < e.top ? d = "bottom" : "bottom" == d && c.bottom + k > e.bottom ? c.top - k >= e.top && (d = "top") : "left" == d && c.left - b < e.left ? d = c.right + b > e.right ? c.top - k < e.top ? "bottom" : "top" : "right" : "right" == d && c.right + b > e.right && (d = c.left - b < e.left ? c.top - k < e.top ? "bottom" : "top" : "left");
                ...
                k = c = 0;
                h = a.find("." + h + "-arrow");
                if ("left" == d || "right" == d) g.top < e.top ? c = e.top - g.top : g.bottom > e.bottom && (c = e.bottom - g.bottom), h.css({
                    left: "",
                    top: 50 - 100 * c / g.top + "%"
                });
                else {
                    g.left < e.left ? k = e.left - g.left : g.left + b > e.right && (k = e.right - (g.left + b));
        ...
        loadContent: function() {
            if (this.loadRequired &&
                ...
                f.isFunction(a) ? (this.loading = !0, a(c, this.options.loadParams)) : c("")
            }
        },
        getTemplate: function() {
            var a = this.options.baseClass;
            return f(f.parseHTML('<div class="' + a + (this.options.extraClass ? " " + this.options.extraClass : "") + '" role="tooltip"><div class="' + a + '-arrow"></div><div class="' + a + '-content"></div></div>'))
        }
    });
    XF.TooltipTrigger = XF.create({
        ...
        init: function() {
            ...
            for (var g = this.options.trigger.split(" "), k = 0; k < g.length; k++) switch (g[k]) {
                case "hover":
                    a.on(l + ".tooltip", XF.proxy(this, "mouseEnter")).on(h + ".tooltip", XF.proxy(this, "leave"));
                    break;
                case "focus":
                    a.on({
            ...
            if (!b && this.options.clickHide) a.onPointer("click.tooltip auxclick.tooltip contextmenu.tooltip", function(e) {
                c && XF.isEventTouchTriggered(e) || (d.hide(), d.stopFocusBefore =
                    Date.now() + 2E3)
            });
            a.on({
        ...
        clickShow: function(a) {
            ...
            setTimeout(function() {
                ...
                else f(p).on("click.tooltip-" + b.$target.xfUniqueId(), XF.proxy(b, "docClick"))
            }, 0);
            this.show()
        },
        addCovers: function() {
            ...
            a = f();
            for (var c,
                    d = 0; d < b.length; d++) c = f('<div class="tooltipCover" />').css(b[d]), a = a.add(c);
        ...
        docClick: function(a) {
            ...
            var d = a.pageY,
                h = f(m);
            b && (0 == a.screenX && 0 == a.screenY && (a = f(a.target).dimensions(), c = a.left, d = a.top), b.addClass("is-active"), c = f(p.elementFromPoint(c - h.scrollLeft(), d - h.scrollTop())), b.removeClass("is-active"), c.is(b) && this.hide())
        },
        ...
        show: function() {
            var a = this;
            f(m).off("focus.tooltip-" + this.$target.xfUniqueId()).on("focus.tooltip-" + this.$target.xfUniqueId(), function(c) {
    ...
    XF.Tooltip = XF.Element.newHandler({
        options: f.extend(!0, {}, XF.TooltipOptions.base, {
            content: null
        }),
        trigger: null,
        tooltip: null,
    ...
    XF.PreviewTooltip = XF.Element.newHandler({
        ...
        tooltip: null,
        init: function() {
            this.options.previewUrl ? (this.tooltip =
                new XF.TooltipElement(XF.proxy(this, "getContent"), {
        ...
        loaded: function(a, b) {
            a.html && XF.setupHtmlInsert(a.html, function(c,
                d, h) {
                b(c)
            })
        }
    ...
    XF.MemberTooltip = XF.Element.newHandler({
        ...
        onShow: function() {
            var a =
                XF.MemberTooltip.activeTooltip;
            a && a !== this && a.hide();
    ...
    XF.ShareTooltip = XF.Element.newHandler({
        ...
        getContent: function(a) {
            ...
            this.trigger.wasClickTriggered() && (c.global = !0);
            XF.ajax("get", this.options.href, {}, function(d) {
                b.loaded(d, a)
            }, c)
        },
        loaded: function(a, b) {
            a.html && XF.setupHtmlInsert(a.html, function(c, d, h) {
                b(c)
            })
        },
        onShow: function() {
